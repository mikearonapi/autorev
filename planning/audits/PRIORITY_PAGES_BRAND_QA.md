...
## Priority Page Structure (5-Tab App)

```
app/(app)/
├── /garage                ← Tab 1: Main hub ✓
...
├── /data                  ← Tab 2: Performance data ✓
├── /community             ← Tab 3: Builds feed ✓
├── /al                    ← Tab 4: AI Assistant ✓
...
for page in \
  ...
  "app/(app)/profile/page.module.css"; do
  if [ -f "$page" ]; then

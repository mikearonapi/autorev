...
| Cancel URL | Redirects to `/profile?checkout=canceled` | Cancel at Stripe checkout |
...
### 10.1 New User (Anonymous → Free)

1. [ ] Visit homepage → CTA buttons work
2. [ ] Click "Join" → Auth modal opens in signup mode
3. [ ] Sign up → Account created, redirects to /garage
4. [ ] Add vehicle to garage → Vehicle saved
5. [ ] Browse community builds → Feed loads

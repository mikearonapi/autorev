...
// Thermal properties
const _STEEL_SPECIFIC_HEAT = 500; // J/(kg·K)
 ...
 */
export function calculateTemperatureRise(vehicleWeightKg, initialSpeedMs, thermalCapacity, _rotorCount = 4, frontBias = 0.65) {
...
export function simulateBrakeTemperature(brakeParams, stops, ambientTempC = 25) {
  const {
    ...
    rearRotorThermalCapacity: _rearRotorThermalCapacity,
    frontBias = 0.65,

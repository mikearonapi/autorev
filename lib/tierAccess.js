...
export const FEATURES = {
  ...
  alCollector: { tier: 'collector', name: 'AL Enthusiast', description: '75 AI chats per month' },
  ...
  installTracking: { tier: 'tuner', name: 'Install Tracking', description: 'Track installation progress with DIY guides and shop finder' },

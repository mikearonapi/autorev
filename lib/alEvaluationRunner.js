...
import { calculateTokenCost } from './alConfig';
import { getAllEvalCases, getRandomEvalCases, LLM_JUDGE_PROMPT } from './alEvaluations';
...
const _ANTHROPIC_MODEL = process.env.ANTHROPIC_MODEL || 'claude-sonnet-4-20250514';
 ...
 */
async function callAL(prompt, carContext = null, _options = {}) {

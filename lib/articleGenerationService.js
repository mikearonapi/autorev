...
const CTA_TEMPLATES = {
  ...
  enthusiast: [
    { text: 'Looking for automotive events near you? <a href="/community">Check our community events</a> for meets, shows, and track days.', context: 'for events' },
 ...
 */
function parseArticleResponse(response, _articleIdea) {
...
export async function getNextArticleToPublish() {
  const ARTICLE_COLS = 'id, slug, title, car_id, car_slug, topic, content_markdown, content_html, excerpt, seo_title, seo_description, featured_image_url, is_published, published_at, view_count, created_at, updated_at';

...
export async function getRecentNegativeFeedback(limit = 50) {
  try {
    ...
    const FEEDBACK_COLUMNS = 'id, user_id, conversation_id, message_id, feedback_type, feedback_category, query_text, response_text, expected_response, notes, created_at';

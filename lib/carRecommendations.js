 ...
 * 
 * @deprecated As of 2026-01-15, this file is DEPRECATED.
 * The cars.upgrade_recommendations column has been removed from the database.
 * 
 ...
 * 
 * These functions now always return null/empty arrays since car.upgradeRecommendations
 * is no longer populated. Keeping this file for backward compatibility only.
 * 
 * Old Schema (cars.upgrade_recommendations - REMOVED):
 * {

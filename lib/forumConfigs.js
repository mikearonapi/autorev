...
export const FORUM_CONFIGS = {
  ...
  corvetteforum: {
    ...
    scrapeConfig: {
      ...
      // Verified URL structure - clean URLs with forum ID suffix
      subforums: {
        '/c8-general-discussion-175/': ['c8-corvette-stingray'],
        '/c7-general-discussion-142/': ['c7-corvette-grand-sport', 'c7-corvette-z06'],
        '/c6-corvette-95/': ['chevrolet-corvette-c6-z06', 'chevrolet-corvette-c6-grand-sport'],
        '/c5-tech-performance-16/': ['chevrolet-corvette-c5-z06'],
      },
      
      threadListSelectors: {
        // CorvetteForum pages present vBulletin-style markup (trow + thread_title_ anchors)

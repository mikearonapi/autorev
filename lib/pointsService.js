 ...
 * 
 * POINTS PHILOSOPHY (5 tiers, aligned to business value):
 * - GROWTH (250): Referrals - new users are most valuable
 * - COMMUNITY (100): Sharing builds - creates social proof
 * - REAL DATA (50): Installed upgrades, dyno, lap times - actual build data
 * - ENGAGEMENT (10): Planning, adding vehicles, comments - getting started
 * - PARTICIPATION (5): Likes, photos - low effort engagement
 * 
 * Categories:
 * - growth_*: Bringing new users
...
export const POINTS_CONFIG = {
  // ==========================================================================
  // GROWTH (250 points) - Highest value: new users
  // ==========================================================================
  referral_signup: {
    points: 250,
    label: 'Refer a friend',
    description: 'A friend signed up with your referral',
    category: 'growth',
  },

  // ==========================================================================
  // COMMUNITY (100 points) - Sharing builds creates social proof
  // ==========================================================================
  ...
  // ==========================================================================
  // REAL DATA (50 points) - Actual data about what people build
  // ==========================================================================
  garage_install_upgrade: {
    points: 50,
    label: 'Install an upgrade',
    description: 'Mark an upgrade as installed on your vehicle',
    category: 'garage',
  },
  data_log_dyno: {
    points: 50,
  ...
  // ==========================================================================
  // ENGAGEMENT (10 points) - Getting started, planning
  // ==========================================================================
  garage_add_vehicle: {
    points: 10,
    label: 'Add a vehicle',
  ...
  garage_plan_upgrade: {
    points: 10,
    label: 'Plan an upgrade',
    description: 'Add an upgrade to your build plan',
    category: 'garage',
  },
  community_comment: {
    points: 10,
    label: 'Comment on a build',
    description: 'Comment on a community build',
    category: 'community',
  },
  al_ask_question: {
    points: 10,
  ...
  insight_questionnaire: {
    points: 10,
    label: 'Answer a question',
    description: 'Complete a personalization question',
    category: 'insights',
  },
  
  // ==========================================================================
  // QUESTIONNAIRE (5-100 points) - Building your Enthusiast Profile
  // ==========================================================================
  questionnaire_answer: {
    points: 5,
    label: 'Answer a profile question',
    description: 'Help AL understand you better',
    category: 'questionnaire',
  },
  questionnaire_category_complete: {
    points: 25,
    label: 'Complete a category',
    description: 'Complete all questions in a profile category',
    category: 'questionnaire',
  },
  questionnaire_50_percent: {
    points: 50,
    label: '50% Profile Complete',
    description: 'Answer half of all profile questions',
    category: 'questionnaire',
  },
  questionnaire_100_percent: {
    points: 100,
    label: '100% Profile Complete',
    description: 'Complete your full Enthusiast Profile',
    category: 'questionnaire',
  },

  // ==========================================================================
  // PARTICIPATION (5 points) - Low effort engagement
  // ==========================================================================
  community_like_post: {
    points: 5,
    label: 'Like a build',
    description: 'Like a community build',
    category: 'community',
  },
  garage_upload_photo: {
    points: 5,
  ...
  insight_feedback: {
    points: 5,
    label: 'Rate an insight',
    description: 'Provide feedback on an insight',
    category: 'insights',
  },

  // ==========================================================================
  // LEGACY/DEPRECATED - kept for backward compatibility with existing history
  // ==========================================================================
  garage_add_modification: {
    points: 10, // Reduced from 50 - use garage_install_upgrade for installs
    label: 'Plan a modification',
    description: 'Add a modification to your build plan',
    category: 'garage',
  },
  garage_add_part_details: {
    points: 5, // Reduced from 25
...
export function getPointsConfigByCategory() {
  const categories = {
    ...
    questionnaire: { label: 'Profile', icon: '📋', actions: [] },
  };
...
export async function getPointsHistory(userId, limit = 20) {
  ...
  try {
    const { data, error } = await supabase
      ...
      .select('id, user_id, points, action_type, action_description, metadata, created_at')
      .eq('user_id', userId)

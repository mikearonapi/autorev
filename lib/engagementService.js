...
export async function fetchEngagementScore(userId) {
  ...
  const ENGAGEMENT_COLS = 'id, user_id, total_score, cars_viewed, cars_favorited, builds_saved, al_conversations, community_posts, community_comments, referrals_sent, last_activity_at, created_at, updated_at';

...
const PREAMBLE_PATTERNS = [
  // Action announcements (including "Now let me..." variations)
  /^I'll research\b[^.!?\n]*[.!?\n]/i,
  /^I will research\b[^.!?\n]*[.!?\n]/i,
  /^Let me research\b[^.!?\n]*[.!?\n]/i,
  /^Now let me research\b[^.!?\n]*[.!?\n]/i,
  /^I'll search\b[^.!?\n]*[.!?\n]/i,
  /^Let me search\b[^.!?\n]*[.!?\n]/i,
  /^Now let me search\b[^.!?\n]*[.!?\n]/i,
  /^I'll look up\b[^.!?\n]*[.!?\n]/i,
  /^Let me look up\b[^.!?\n]*[.!?\n]/i,
  /^Now let me look up\b[^.!?\n]*[.!?\n]/i,
  /^I'll compare\b[^.!?\n]*[.!?\n]/i,
  /^Let me compare\b[^.!?\n]*[.!?\n]/i,
  /^Now let me compare\b[^.!?\n]*[.!?\n]/i,
  /^I'll pull up\b[^.!?\n]*[.!?\n]/i,
  /^Let me pull up\b[^.!?\n]*[.!?\n]/i,
  /^Now let me pull up\b[^.!?\n]*[.!?\n]/i,
  /^I'll find\b[^.!?\n]*[.!?\n]/i,
  /^Let me find\b[^.!?\n]*[.!?\n]/i,
  /^Now let me find\b[^.!?\n]*[.!?\n]/i,
  /^I'll get\b[^.!?\n]*[.!?\n]/i,
  ...
  /^Based on the research results\b[^.!?\n]*[.!?\n:]/i,
  /^Based on the results\b[^.!?\n]*[.!?\n:]/i,
  /^Based on my research\b[^.!?\n]*[.!?\n:]/i,
  ...
  // Mid-sentence preamble (NOT at start of text) - handles cases like:
  // "comparison.Now let me get some community insights..."
  /(?<=\.)\s*Now let me (?:get|search|find|check|look|pull|compare|research)\b[^.!?\n]*[.!?\n]/gi,
];
...
const MULTI_SENTENCE_PREAMBLE_PATTERNS = [
  ...
  // Pattern: "I'll search X. Based on the research results, I'll compile Y:"
  /^(?:I'll |I will |Let me )[\s\S]*?(?:Based on (?:the )?(?:research )?results|I'll compile)[\s\S]*?(?=##|\*\*\d|\d\)|\d\.|Top \d)/i,
];
...
const PREAMBLE_START_PATTERNS = [
  ...
  /^Let me help\b/i,
  /^First,? I'll\b/i,
  /^Based on (?:the )?(?:research )?results\b/i,
  /^Based on my research\b/i,
];

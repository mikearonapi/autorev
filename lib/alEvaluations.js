...
export const EVAL_CASES = [
  ...
  // ============================================
  // YEAR-SPECIFIC ACCURACY (Critical - tests mid-generation changes)
  // ============================================
  {
    id: 'year-specific-cobra-irs',
    category: 'reliability',
    prompt: 'What suspension does my 1996 Mustang Cobra have?',
    carContext: null,
    expectedElements: ['solid rear axle', 'solid axle', 'live axle', '1999'],
    forbiddenElements: ['IRS', 'independent rear suspension'],
    minToolCalls: ['get_car_ai_context'],
    difficulty: 'hard',
    judgePrompt:
      'CRITICAL: 1996 Cobra has SOLID REAR AXLE, NOT IRS. IRS was introduced in 1999. Any mention of IRS for a 1996 is a FAIL.',
  },
  {
    id: 'year-specific-cobra-coilovers',
    category: 'upgrades',
    prompt: 'Best coilovers for my 1997 SVT Cobra for track use',
    carContext: null,
    expectedElements: ['solid axle', 'SN95'],
    forbiddenElements: ['IRS coilovers', 'IRS-specific', 'independent rear'],
    minToolCalls: ['research_parts_live'],
    difficulty: 'hard',
    judgePrompt:
      'CRITICAL: 1997 Cobra has SOLID REAR AXLE. Must recommend solid-axle specific coilovers. IRS coilovers will NOT fit.',
  },
  {
    id: 'year-specific-997-ims',
    category: 'reliability',
    prompt: 'Should I worry about IMS bearing on a 2010 997?',
    carContext: '997-carrera',
    expectedElements: ['2009', 'DFI', 'no IMS', 'not a concern'],
    forbiddenElements: ['replace IMS', 'IMS bearing failure'],
    minToolCalls: ['get_car_ai_context'],
    difficulty: 'hard',
    judgePrompt:
      'CRITICAL: 2009+ 997s have DFI engine with NO IMS bearing. Any recommendation to replace/worry about IMS is incorrect.',
  },

  // ============================================
  // TOOL USAGE VALIDATION (Tests that tools are used for car-specific questions)
  // ============================================
  {
    id: 'tool-usage-maintenance-specific-car',
    category: 'maintenance',
    prompt: 'How do I take care of my 2020 Ford Mustang EcoBoost with 100k miles?',
    carContext: null,
    expectedElements: ['oil', 'transmission', 'spark plugs', 'turbo', 'coolant'],
    forbiddenElements: [],
    minToolCalls: ['get_maintenance_schedule'],
    maxToolCalls: 5,
    difficulty: 'hard',
    judgePrompt:
      'CRITICAL: Car-specific maintenance questions MUST use get_maintenance_schedule or search_web. Empty tool_calls is a FAIL.',
  },
  {
    id: 'tool-usage-unknown-car',
    category: 'maintenance',
    prompt: 'What maintenance does my 2015 Kia Stinger GT need at 80k miles?',
    carContext: null,
    expectedElements: ['oil', 'brake fluid', 'transmission', 'coolant'],
    forbiddenElements: ["I don't have", "can't find"],
    minToolCalls: ['search_web'],
    difficulty: 'hard',
    judgePrompt:
      'Car not in database - MUST use search_web to find maintenance info. Should not fall back to generic advice only.',
  },

  // ============================================
  // MYTH AVOIDANCE (Tests that outdated advice is NOT given)
  // ============================================
  {
    id: 'myth-turbo-cooldown',
    category: 'maintenance',
    prompt: 'Do I need to let my 2020 EcoBoost idle before turning it off?',
    carContext: null,
    expectedElements: ['water-cooled', 'modern turbo', 'not necessary', 'unnecessary'],
    forbiddenElements: ['30 seconds', '60 seconds', 'always idle', 'let it idle'],
    minToolCalls: [],
    difficulty: 'hard',
    judgePrompt:
      'MYTH CHECK: Modern turbos (2000s+) have water-cooled bearings and do NOT require cool-down idling. Recommending 30-60s idle is OUTDATED advice.',
  },
  {
    id: 'myth-oil-change-3000',
    category: 'maintenance',
    prompt: 'Should I change my oil every 3000 miles on my new BMW M3?',
    carContext: 'bmw-m3-g80',
    expectedElements: ['synthetic', '7500', '10000', 'manufacturer', 'owner manual'],
    forbiddenElements: ['3000 miles is best', 'always 3000'],
    minToolCalls: ['get_maintenance_schedule'],
    difficulty: 'medium',
    judgePrompt:
      'MYTH CHECK: Modern synthetic oils last 7,500-15,000 miles. 3,000 mile intervals are outdated for modern cars with synthetic oil.',
  },

  // ============================================
  // BRAND VERIFICATION (Tests that claims are verified)
  // ============================================
  {
    id: 'brand-verification-exhaust',
    category: 'upgrades',
    prompt: 'Does Flowmaster make exhausts for Porsches?',
    carContext: null,
    expectedElements: ['American vehicles', 'Ford', 'Chevrolet', 'no Porsche'],
    forbiddenElements: [],
    minToolCalls: ['search_web'],
    difficulty: 'medium',
    judgePrompt:
      "VERIFICATION CHECK: Claims about what brands do/don't support should be verified with search_web, not answered from memory alone.",
  },
];

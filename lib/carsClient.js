...
import { carData as localCarData, getCarBySlug as getLocalCarBySlug, tierConfig, categories } from '@/data/cars.js';

// Configuration
const REQUEST_TIMEOUT_MS = 8000; // 8 second timeout
const CACHE_TTL_MS = 5 * 60 * 1000; // 5 minutes cache

// Re-export config data that's not car-specific (constants, not database data)
export { tierConfig, categories };

...
export const GOAL_CATEGORY_MAP = {
  track: {
    primary: ['brakes', 'cooling', 'chassis', 'aero'],
    secondary: ['power', 'forcedInduction', 'drivetrain'],
    label: 'Track Ready',
    description: 'Optimized for lap times and track performance',
  },
  street: {
    primary: ['power', 'forcedInduction', 'chassis'],
    secondary: ['brakes', 'aero', 'drivetrain'],

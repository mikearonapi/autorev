...
export async function createConversation(
  userId,
  { carSlug = null, page = null, title = null, firstMessage = null } = {}
) {
...
export async function getConversation(conversationId) {
  ...
  const CONVERSATION_COLUMNS =
    'id, user_id, title, summary, initial_car_slug, initial_page, message_count, total_credits_used, is_archived, is_pinned, last_message_at, created_at, updated_at';

...
export async function fetchFeaturedArticles(limit = 4) {
  ...
  const ARTICLE_COLS = 'id, slug, title, car_id, car_slug, topic, excerpt, seo_title, seo_description, featured_image_url, is_published, is_featured, published_at, view_count, created_at, updated_at';

...
import { getEngineType, getHpGainMultiplier, getPlatformDownpipeGain } from '../../data/upgradePackages.js';
...
export function calculateAllModificationGains(installedMods, car = null) {
  ...
  // ==========================================================================
  const modKeys = installedMods.map(mod => {
  ...
  if (car) {
    ...
    const activeTune = modKeys.find(m => m === 'stage3-tune') ||

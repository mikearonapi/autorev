...
export const modificationCategories = {
  ...
  engine: {
    ...
    icon: 'bolt',
    description:
      'Internal engine modifications that increase horsepower, torque, and engine capability. From camshafts to forged internals.',
    color: '#e74c3c',
  ...
  cooling: {
    ...
    icon: 'thermometer',
    description:
      'Keep your engine, transmission, and differentials running cool under stress. Essential for track days and hot climates.',
    color: '#1abc9c',
  ...
  'fuel-system': {
    ...
    icon: 'fuel',
    description:
      'Fuel delivery upgrades for increased power demands. From high-pressure fuel pumps to complete fuel system overhauls.',
    color: '#f1c40f',
  ...
  'ecu-tuning': {
    ...
    icon: 'cpu',
    description:
      'Electronic control unit modifications and engine calibration. The brain of your engine—unlock hidden power through software.',
    color: '#9b59b6',
  ...
  'intake-fi': {
    ...
    icon: 'turbo',
    description:
      'Air intake improvements and forced induction systems. From cold air intakes to superchargers and turbo kits for massive power gains.',
    color: '#8e44ad',
  ...
  engineSwaps: {
    ...
    icon: 'engine',
    description:
      'Complete engine replacement with a more powerful or capable powerplant. The ultimate performance modification.',
    color: '#c0392b',
  ...
  safety: {
    ...
    icon: 'shield',
    description:
      'Safety equipment for track use. DEPRECATED: This content has been moved to the Track Day Prep build guide.',
    color: '#c0392b',
    linkedSystems: [],
    sortOrder: 99,
    deprecated: true,
  ...
  weightReduction: {
    ...
    icon: 'feather',
    description:
      'Lightweight components and weight reduction strategies. DEPRECATED: This content has been moved to the Weight Reduction build guide.',
    color: '#7f8c8d',
    linkedSystems: [],
    sortOrder: 99,
    deprecated: true,
...
export const modificationTopicLinks = {
  ...
  // Note: throttle-body, intake-manifold, charge-pipe-upgrade removed
  ...
  intercooler: ['intercooler-types', 'supercharger-types'], // also covers SC heat exchangers
...
export const modificationCategoryReassignment = {
  // From 'power' → split across fuel-system, ecu-tuning, intake-fi
  // Note: throttle-body, intake-manifold, camshafts, ported-heads, hpfp-upgrade, charge-pipe-upgrade, forged-internals, stroker-kit removed
  ...
  intercooler: 'intake-fi', // also covers heat-exchanger-sc
...
const modificationCategoriesModule = {
...
export default modificationCategoriesModule;

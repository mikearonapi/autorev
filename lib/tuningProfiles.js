...
export async function getTuningProfile(carSlug, options = {}) {
  ...
  const TUNING_COLS = 'id, car_id, car_variant_id, tuning_focus, platform_strengths, platform_weaknesses, upgrades_by_objective, baseline_metrics, compatibility_notes, created_at, updated_at';

    ...
    stages: [
      {
        ...
        concepts: [
          {
            type: 'PAIRS_WELL',
            text: 'Intake + tune work together - the tune adjusts for increased airflow',
          },
        ],
        considerations: [
      ...
      },
      {
        ...
        upgrades: ['downpipe', 'intercooler', 'cat-back-exhaust'],
      ...
      },
      {
        ...
        upgrades: ['turbo-upgrade-existing', 'fuel-system-upgrade', 'clutch-upgrade'],
        primaryUpgrade: 'turbo-upgrade-existing',
        expectedGains: '100-300+ hp',
        concepts: [
          {
            type: 'REQUIRES',
            text: "Big turbos REQUIRE upgraded fuel systems - stock can't keep up",
          },
          {
            type: 'STRESSES',
            text: 'This power level stresses drivetrain, cooling, and engine internals',
          },
        ],
        prerequisites: ['Complete Stage 1 & 2', 'Upgraded clutch'],
        considerations: [
    ...
    stages: [
      {
        ...
        concepts: [
          {
            type: 'PAIRS_WELL',
            text: 'Tires + alignment go together - new tires need proper setup',
          },
        ],
        considerations: [
      ...
      },
      {
        ...
        concepts: [
          {
            type: 'INVALIDATES',
            text: 'Coilovers change ride height → alignment is REQUIRED after install',
          },
          {
            type: 'PAIRS_WELL',
            text: 'Chassis bracing + coilovers maximize suspension effectiveness',
          },
        ],
    ...
    stages: [
      {
        ...
        concepts: [
          {
            type: 'REQUIRES',
            text: 'Track pads REQUIRE high-temp brake fluid - stock fluid will boil',
          },
          {
            type: 'STRESSES',
            text: 'Track driving stresses brakes heavily - pads and fluid are safety items',
          },
        ],
        considerations: [
      ...
      },
      {
        ...
        upgrades: ['wheels-lightweight', 'splitter', 'wing', 'roll-bar', 'big-brake-kit'],
        primaryUpgrade: 'splitter',
        expectedGains: '5-10+ seconds per lap',
        concepts: [
          { type: 'REQUIRES', text: 'Track compound tires (select via Wheel & Tire configurator)' },
        ...
        considerations: [
          'Select track compound tires via configurator - dangerous in rain',
    ...
    stages: [
      {
        ...
        concepts: [{ type: 'PAIRS_WELL', text: 'Pads + stainless lines = firm, consistent pedal' }],
        considerations: [
    ...
    stages: [
      {
        ...
        concepts: [
          {
            type: 'PAIRS_WELL',
            text: 'Oil cooler + quality fluids protect your engine investment',
          },
        ],
        considerations: [
      ...
      },
      {
        ...
        upgrades: ['clutch-upgrade', 'axles-halfshafts', 'driveshaft-upgrade'],
        primaryUpgrade: 'clutch-upgrade',
        expectedGains: 'Reliable power delivery at higher levels',
        concepts: [
          {
            type: 'STRESSES',
            text: 'High power stresses clutch, axles, diff - upgrade proactively',
          },
        ],

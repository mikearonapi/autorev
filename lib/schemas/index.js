...
export const feedbackSchema = z.object({
  ...
  car_id: optionalUuidSchema, // Preferred: use car_id directly
  car_slug: z.string().max(100).optional().nullable(), // Deprecated: kept for backward compatibility
  build_id: optionalUuidSchema,

  // Metadata
  // Note: Zod 4 bug requires explicit key type for z.record() when value is z.unknown()
  tags: z.array(z.string().max(50)).max(10).optional(),
  metadata: z.record(z.string(), z.unknown()).optional().nullable(),
  browserInfo: z.record(z.string(), z.unknown()).optional().nullable(),
  ...
  errorMetadata: z.record(z.string(), z.unknown()).optional().nullable(),
  ...
  screenshot_metadata: z.record(z.string(), z.unknown()).optional().nullable(),
});
...
export const alFeedbackSchema = z.object({
  ...
  carContextSlug: z.string().max(200).optional().nullable(), // What car was being discussed
  agentType: z.string().max(50).optional().nullable(), // Which specialist agent responded
...
export const preferencesQuestionnaireSchema = z.object({
  // Note: Zod 4 bug requires explicit key type for z.record()
...
export const trackTimeSchema = z.object({
  ...
  // Note: Zod 4 bug requires explicit key type for z.record() when value is z.unknown()
  // See: https://github.com/colinhacks/zod/issues - z.record(z.unknown()) fails on non-empty objects
  modsSummary: z.record(z.string(), z.unknown()).optional().nullable(),

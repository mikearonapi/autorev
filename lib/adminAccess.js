 ...
 * Returns null if authorized, or a Response to return if not
 * 
 * @param {Request} request - Next.js request object
 * @returns {Promise<Response|null>} - null if authorized, Response if not
 * 
 * @example
...
export async function requireAdmin(request) {
  ...
  if (error === 'No auth token provided' || error === 'Missing authorization header') {

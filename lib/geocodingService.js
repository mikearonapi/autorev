...
export async function geocodeLocation(location) {
  ...
  // This handles cases like "Great Falls" without state
  ...
  try {
    ...
    console.debug('[Geocoding] Free-form search:', trimmed);
    ...
    if (!data || data.length === 0) {
      console.debug('[Geocoding] No results for:', trimmed);
    ...
    console.debug('[Geocoding] Free-form success:', trimmed, '->', result);

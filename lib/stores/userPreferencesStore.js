...
const STORAGE_KEY = 'autorev_user_preferences';
...
export function loadPreferences() {
  ...
  try {
    ...
    console.warn('[UserPreferencesStore] Failed to load preferences:', err);
  }
...
export function savePreferences(preferences) {
  ...
  try {
    ...
    console.warn('[UserPreferencesStore] Failed to save preferences:', err);
  }
}
...
export function clearPreferences() {
  ...
  try {
    ...
    console.warn('[UserPreferencesStore] Failed to clear preferences:', err);
  }
}

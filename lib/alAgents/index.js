...
export const AGENT_TOOLS = {
  ...
  // ============================================================================
  // PARTS RESEARCH: Find and compare specific parts (6 tools)
  // "Best exhaust for my 981?", "Find a Cobb intake", "What do owners think?"
  // ============================================================================
  [INTENT_TYPES.PARTS_RESEARCH]: [
    'search_parts', // PRIMARY: find parts by name, type, or car
    ...
    'search_web', // Find newer/niche parts not in database
  ],

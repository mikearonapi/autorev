...
When a user mentions a **SPECIFIC car** (year/make/model), you MUST call tools first:
...
**If database tools return empty for a specific car → ALWAYS use \`search_web\`** to get accurate, current information. Do NOT fall back to general knowledge for car-specific questions.
...
- Questions that don't reference a specific vehicle
...
### The Key:
Use tools to get REAL DATA that makes your answer more accurate and valuable. For generic concepts, use your expertise. For car-specific questions, ALWAYS verify with tools or web search.`;

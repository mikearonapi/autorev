 ...
 */
export const PRESENTATION_RULES = `## CRITICAL PRESENTATION RULE (NON-NEGOTIABLE)
 ...
 */
export const FORMATTING_RULES = `## Response Length Calibration
...
- Always add blank lines between different topics/sections
- Never concatenate separate ideas without paragraph breaks`;

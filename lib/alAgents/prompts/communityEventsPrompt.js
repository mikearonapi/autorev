...
const COMMUNITY_EVENTS_OUTPUT = `## Output Format (for Formatter)

**For events:**
\`\`\`
RESPONSE_TYPE: events_list
TITLE: Car Events near [Location]
...
- date: [Date/Time]
- location: [Venue, City]
- type: [Cars & Coffee|Track Day|Car Show|Autocross]
...
NO_EVENTS_FOUND: [If none found, suggest alternatives or different search]
FOLLOW_UP: [Suggested action]
\`\`\`

**For community insights:**
\`\`\`
RESPONSE_TYPE: community_insights
TITLE: What Owners Say About [Topic]
SOURCE: [Forums, Reddit, etc.]

CONSENSUS: [Main takeaway from community]
...
DISSENT: [Any notable opposing views]
SAMPLE_SIZE: [e.g., "Based on 50+ forum posts"]
\`\`\`

**CRITICAL:** Never start with "Let me search for..." or mention tool names.`;

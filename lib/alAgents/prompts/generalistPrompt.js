...
const GENERALIST_OUTPUT = `## Output Format (for Formatter)
...
**For chitchat/greetings:** Just respond naturally without the structured format.
The Formatter will pass through conversational responses with minimal changes.

**CRITICAL:** Never start with "I'd be happy to..." or similar robotic phrases.`;

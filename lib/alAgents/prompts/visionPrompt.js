...
const VISION_FORMATTING = `## Response Format

Structure your analysis clearly:

**What I See:** [Objective description]

**Analysis:** [Your interpretation]

**Recommendations:** [What the user should do next]

Keep responses focused on what's actually visible. Don't speculate beyond the image without clear caveats.`;

...
export async function fetchImages(params) {
  ...
  const IMG_COLS = 'id, user_id, user_vehicle_id, user_build_id, community_post_id, blob_url, thumbnail_url, original_filename, file_size, width, height, media_type, caption, is_primary, display_order, created_at';

...
export const ONBOARDING_IMAGES = {
  ...
  // PERF: WebP versions are 86% smaller than PNG for faster LCP
  ...
  // PERF: WebP versions are 80-88% smaller than PNG for faster landing page LCP
  tuningShopOverview: '/images/onboarding/tuning-shop-01-overview.webp',
  ...
  // PERF: WebP versions are 76-91% smaller than PNG
  aiAlIntro: '/images/onboarding/ai-al-01-intro.webp',
  aiAlThinking: '/images/onboarding/ai-al-03-thinking.webp',
  aiAlResponseMods: '/images/onboarding/ai-al-04-response-mods.webp',

...
export const SITE_DESIGN_IMAGES = {
  ...
  // ==========================================================================
  heroCenter: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.webp?v=2`, // Garage with RS5 hero card - Mike's Garage (updated Jan 31)
  heroLeft: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.webp`, // Recommended upgrades
  heroRight: `${BLOB_BASE_URL}/site-design-v2/al-chat-response.webp`, // AL chat response (headers/tune)

  // ==========================================================================
  // FEATURE SECTIONS - Used in homepage feature cards
  // ==========================================================================
  garageOverview: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.webp?v=2`, // "Your Garage" section - Mike's Garage (updated Jan 31)
  ...
  alChatResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-response.webp`, // "Ask AL Anything"
...
export const ONBOARDING_IMAGES = {
  ...
  alChatSuggestions: `${BLOB_BASE_URL}/site-design-v2/ask-al-parts-suggestions-modal.webp`,
  alChatThinking: `${BLOB_BASE_URL}/site-design-v2/al-chat-thinking-state.webp`,
  alChatResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-response.webp`,
 ...
 * Priority order:
 * 1. Vercel Blob URL from database (imageUrl) - works in both dev and prod
...
export function getCarPlaceholderProps(car) {
  return {
    ...
    text: car.name,
    subtext: car.year ? String(car.year) : '',
  };
}
...
export function getImageGenMetadata(car) {
  return {
    ...
    promptHints: {
      ...
      era: getEraFromYears(car.year ? String(car.year) : ''),

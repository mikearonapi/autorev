...
export const UI_IMAGES = {
  alMascot: '/images/al-mascot.png',
  logoTrimmed: '/images/autorev-logo-trimmed.png',
};

/**
 * Onboarding screenshots stored in the public folder (already TinyPNG-optimized).
 * If/when these move to Blob, only this map needs updating.
 */
export const ONBOARDING_IMAGES = {
  ...
  carSelectorPreferences: '/images/onboarding/car-selector-01-preferences.png',
  carSelectorResults: '/images/onboarding/car-selector-02-results.png',
  ...
  tuningShopOverview: '/images/onboarding/tuning-shop-01-overview.png',
  tuningShopWheels: '/images/onboarding/tuning-shop-02-config-wheels.png',
  tuningShopPresets: '/images/onboarding/tuning-shop-03-presets.png',
  tuningShopPowerList: '/images/onboarding/tuning-shop-04-power-list.png',
  tuningShopPartDetail: '/images/onboarding/tuning-shop-05-part-detail.png',
  tuningShopMetrics: '/images/onboarding/tuning-shop-06-metrics.png',

  communityEventsList: '/images/onboarding/community-01-events-list.png',
  communityEventDetail: '/images/onboarding/community-02-event-detail.png',

  aiAlIntro: '/images/onboarding/ai-al-01-intro.png',
  aiAlThinking: '/images/onboarding/ai-al-03-thinking.png',
  aiAlResponseMods: '/images/onboarding/ai-al-04-response-mods.png',
  aiAlResponseAnalysis: '/images/onboarding/ai-al-05-response-analysis.png',
};

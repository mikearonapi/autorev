...
export const SITE_DESIGN_IMAGES = {
  ...
  // ==========================================================================
  heroCenter: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.png`, // Garage with RS5 hero card (user's garage photo)
  heroLeft: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`, // Recommended upgrades
  heroRight: `${BLOB_BASE_URL}/site-design-v2/al-chat-exhaust-recommendations.png`, // AL chat response

  // ==========================================================================
  // FEATURE SECTIONS - Used in homepage feature cards
  // ==========================================================================
  garageOverview: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.png`, // "Your Garage" section
  garageData: `${BLOB_BASE_URL}/site-design-v2/data-virtual-dyno-chart.png`, // "Virtual Dyno" section
  garageMetrics: `${BLOB_BASE_URL}/site-design-v2/data-performance-metrics-scores.png`, // Performance metrics
  tuningOverview: `${BLOB_BASE_URL}/site-design-v2/build-categories-overview.png`, // "Plan Your Build" section
  performanceMetrics: `${BLOB_BASE_URL}/site-design-v2/data-performance-metrics-scores.png`, // "Know Your Numbers"
  lapTimeEstimator: `${BLOB_BASE_URL}/site-design-v2/data-track-lap-time-estimator.png`, // "Track Your Times"
  communityFeed: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`, // "Community Builds"
  alChatResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-exhaust-recommendations.png`, // "Ask AL Anything"

  // ==========================================================================
  // BUILD SECTION - Upgrade category pickers
  // ==========================================================================
  buildCategories: `${BLOB_BASE_URL}/site-design-v2/build-categories-overview.png`,
  buildEngine: `${BLOB_BASE_URL}/site-design-v2/build-engine-performance-picker.png`,
  buildExhaust: `${BLOB_BASE_URL}/site-design-v2/build-exhaust-picker.png`,
  buildForcedInduction: `${BLOB_BASE_URL}/site-design-v2/build-forced-induction-picker.png`,
  buildSuspension: `${BLOB_BASE_URL}/site-design-v2/build-suspension-handling-picker.png`,
  buildBrakes: `${BLOB_BASE_URL}/site-design-v2/build-brakes-picker.png`,
  buildCooling: `${BLOB_BASE_URL}/site-design-v2/build-cooling-picker.png`,
  buildWheels: `${BLOB_BASE_URL}/site-design-v2/build-wheels-tires-picker.png`,
  buildAero: `${BLOB_BASE_URL}/site-design-v2/build-body-aero-picker.png`,
  buildDrivetrain: `${BLOB_BASE_URL}/site-design-v2/build-drivetrain-picker.png`,
  tuningRecommendations: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,

  // ==========================================================================
  // DATA SECTION - Dyno, metrics, lap times
  // ==========================================================================
  dataVirtualDyno: `${BLOB_BASE_URL}/site-design-v2/data-virtual-dyno-chart.png`,
  dataPerformanceMetrics: `${BLOB_BASE_URL}/site-design-v2/data-performance-metrics-scores.png`,
  dataPowerBreakdown: `${BLOB_BASE_URL}/site-design-v2/data-power-breakdown-chart.png`,
  dataLapTimeEstimator: `${BLOB_BASE_URL}/site-design-v2/data-track-lap-time-estimator.png`,
  dataPersonalBest: `${BLOB_BASE_URL}/site-design-v2/data-track-personal-best.png`,
  logDynoForm: `${BLOB_BASE_URL}/site-design-v2/data-log-dyno-result-modal.png`,
  logLapTimeForm: `${BLOB_BASE_URL}/site-design-v2/data-log-lap-time-modal.png`,
  powerBreakdown: `${BLOB_BASE_URL}/site-design-v2/data-power-breakdown-chart.png`,

  // ==========================================================================
  // AL CHAT SECTION - Various states and responses
  // ==========================================================================
  alChatHome: `${BLOB_BASE_URL}/site-design-v2/al-chat-welcome.png`,
  alChatWelcome: `${BLOB_BASE_URL}/site-design-v2/al-chat-welcome.png`,
  alChatThinking: `${BLOB_BASE_URL}/site-design-v2/al-chat-thinking-state.png`,
  alChatSuggestions: `${BLOB_BASE_URL}/site-design-v2/ask-al-parts-suggestions-modal.png`,
  alChatExhaustResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-exhaust-recommendations.png`,
  alChatComparisonResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-cayman-vs-gt350-response.png`,
  alChatHeadersResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-headers-tune-response.png`,
  alChatTireResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-tire-fitment-response.png`,
  alChatHistory: `${BLOB_BASE_URL}/site-design-v2/al-conversation-history-sidebar.png`,

  // ==========================================================================
  // COMMUNITY SECTION
  // ==========================================================================
  communityBuildsFeed: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`,
  communityBuildEvoX: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`,
  communityBuildMetrics: `${BLOB_BASE_URL}/site-design-v2/community-build-detail-metrics.png`,
  communityComments: `${BLOB_BASE_URL}/site-design-v2/community-comments-section.png`,
  communityEvents: `${BLOB_BASE_URL}/site-design-v2/community-events-calendar.png`,
  communityLeaderboard: `${BLOB_BASE_URL}/site-design-v2/community-monthly-leaderboard.png`,

  // ==========================================================================
  // INSIGHTS SECTION
  // ==========================================================================
  insightsRecommended: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,
  insightsBuildProgression: `${BLOB_BASE_URL}/site-design-v2/insights-build-progression.png`,
  insightsBuildStages: `${BLOB_BASE_URL}/site-design-v2/insights-build-stages-detail.png`,
  insightsPlatformTips: `${BLOB_BASE_URL}/site-design-v2/insights-platform-tips.png`,
  recommendedUpgrades: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,
  platformInsights: `${BLOB_BASE_URL}/site-design-v2/insights-platform-tips.png`,
  tuningProgression: `${BLOB_BASE_URL}/site-design-v2/insights-build-progression.png`,
  tuningAnalysis: `${BLOB_BASE_URL}/site-design-v2/insights-build-stages-detail.png`,

  // ==========================================================================
  // GARAGE & SPECS
  // ==========================================================================
  garageHero: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.png`,
  specsPerformance: `${BLOB_BASE_URL}/site-design-v2/specs-stock-performance.png`,
  specsVehicleSelector: `${BLOB_BASE_URL}/site-design-v2/specs-vehicle-selector.png`,
  photosGallery: `${BLOB_BASE_URL}/site-design-v2/photos-gallery-hero.png`,
  vehicleSpecs: `${BLOB_BASE_URL}/site-design-v2/specs-stock-performance.png`,
  specsDropdown: `${BLOB_BASE_URL}/site-design-v2/specs-vehicle-selector.png`,

  // ==========================================================================
  // INSTALL & PARTS
  // ==========================================================================
  partsShoppingList: `${BLOB_BASE_URL}/site-design-v2/parts-shopping-list-al-picks.png`,
  installGuideDiy: `${BLOB_BASE_URL}/site-design-v2/install-guide-diy-list.png`,
  installTools: `${BLOB_BASE_URL}/site-design-v2/install-tools-needed.png`,
  installVideos: `${BLOB_BASE_URL}/site-design-v2/install-videos-exhaust.png`,

  // ==========================================================================
  // ONBOARDING & MISC
  // ==========================================================================
  splashLogo: `${BLOB_BASE_URL}/site-design-v2/splash-screen-logo.png`,
  onboardingGarage: `${BLOB_BASE_URL}/site-design-v2/onboarding-welcome-garage.png`,
  onboardingData: `${BLOB_BASE_URL}/site-design-v2/onboarding-welcome-data.png`,
  profileDashboard: `${BLOB_BASE_URL}/site-design-v2/profile-dashboard-stats.png`,

  // ==========================================================================
  // LEGACY ALIASES (keeping for backward compatibility)
  // ==========================================================================
  communityBuildRS5: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`,
  addVehicleModal: `${BLOB_BASE_URL}/site-design-v2/specs-vehicle-selector.png`,
  knownIssues: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,
  powerUpgradesModal: `${BLOB_BASE_URL}/site-design-v2/build-engine-performance-picker.png`,
  profileSettings: `${BLOB_BASE_URL}/site-design-v2/profile-dashboard-stats.png`,
  advancedTuning: `${BLOB_BASE_URL}/site-design-v2/build-categories-overview.png`,
  fuelConfig: `${BLOB_BASE_URL}/site-design-v2/build-engine-performance-picker.png`,
  configureUpgrades: `${BLOB_BASE_URL}/site-design-v2/build-categories-overview.png`,
  garageLoading: `${BLOB_BASE_URL}/site-design-v2/splash-screen-logo.png`,
};
...
export const ONBOARDING_IMAGES = {
  ...
  // ==========================================================================
  garageCard: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.png`,
  garageAddVehicle: `${BLOB_BASE_URL}/site-design-v2/specs-vehicle-selector.png`,
  garagePhotos: `${BLOB_BASE_URL}/site-design-v2/photos-gallery-hero.png`,
  garageSpecs: `${BLOB_BASE_URL}/site-design-v2/specs-stock-performance.png`,
  garageKnownIssues: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,
  ...
  dataVirtualDyno: `${BLOB_BASE_URL}/site-design-v2/data-virtual-dyno-chart.png`,
  dataLapTimeEstimator: `${BLOB_BASE_URL}/site-design-v2/data-track-lap-time-estimator.png`,
  dataExperienceScores: `${BLOB_BASE_URL}/site-design-v2/data-performance-metrics-scores.png`,
  dataPowerBreakdown: `${BLOB_BASE_URL}/site-design-v2/data-power-breakdown-chart.png`,

  // ==========================================================================
  // COMMUNITY - Browse builds, discover events
  // ==========================================================================
  communityFeed: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`,
  communityBuildEvoX: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`,
  communityBuildRS5: `${BLOB_BASE_URL}/site-design-v2/community-builds-evo-x-track.png`,
  communityBuildMods: `${BLOB_BASE_URL}/site-design-v2/community-build-detail-metrics.png`,
  communityEvents: `${BLOB_BASE_URL}/site-design-v2/community-events-calendar.png`,
  communityLeaderboard: `${BLOB_BASE_URL}/site-design-v2/community-monthly-leaderboard.png`,
  ...
  alChatSuggestions: `${BLOB_BASE_URL}/site-design-v2/ask-al-parts-suggestions-modal.png`,
  alChatThinking: `${BLOB_BASE_URL}/site-design-v2/al-chat-thinking-state.png`,
  alChatResponse: `${BLOB_BASE_URL}/site-design-v2/al-chat-exhaust-recommendations.png`,
  ...
  // ==========================================================================
  garageOverview: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.png`,
  tuningShopOverview: `${BLOB_BASE_URL}/site-design-v2/build-categories-overview.png`,
  aiAlResponseMods: `${BLOB_BASE_URL}/site-design-v2/al-chat-exhaust-recommendations.png`,
  communityEventsList: `${BLOB_BASE_URL}/site-design-v2/community-events-calendar.png`,
  ...
  garageHero: `${BLOB_BASE_URL}/site-design-v2/garage-audi-rs5-hero.png`,
  garageDetails: `${BLOB_BASE_URL}/site-design-v2/specs-stock-performance.png`,
  garageReference: `${BLOB_BASE_URL}/site-design-v2/specs-stock-performance.png`,
  garageSafety: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,
  garageHealth: `${BLOB_BASE_URL}/site-design-v2/insights-recommended-upgrades.png`,
  tuningShopWheels: `${BLOB_BASE_URL}/site-design-v2/build-wheels-tires-picker.png`,
  tuningShopPresets: `${BLOB_BASE_URL}/site-design-v2/build-categories-overview.png`,
  tuningShopPowerList: `${BLOB_BASE_URL}/site-design-v2/build-engine-performance-picker.png`,
  tuningShopPartDetail: `${BLOB_BASE_URL}/site-design-v2/parts-shopping-list-al-picks.png`,
  tuningShopMetrics: `${BLOB_BASE_URL}/site-design-v2/data-performance-metrics-scores.png`,
  communityEventDetail: `${BLOB_BASE_URL}/site-design-v2/community-events-calendar.png`,
  aiAlIntro: `${BLOB_BASE_URL}/site-design-v2/al-chat-welcome.png`,
  aiAlThinking: `${BLOB_BASE_URL}/site-design-v2/al-chat-thinking-state.png`,
  aiAlResponseAnalysis: `${BLOB_BASE_URL}/site-design-v2/al-chat-exhaust-recommendations.png`,
};

...
export const SITE_DESIGN_IMAGES = {
  ...
  // ==========================================================================
  heroCenter: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.webp`, // Garage with RS5 hero card (user's garage photo)
  ...
  // ==========================================================================
  garageOverview: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.webp`, // "Your Garage" section (user's garage photo)
  ...
  // GARAGE & SPECS
  // ==========================================================================
  garageHero: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.webp`, // User's garage photo
...
export const ONBOARDING_IMAGES = {
  ...
  // ==========================================================================
  garageCard: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.webp`, // User's garage photo
  ...
  // ==========================================================================
  garageOverview: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.webp`, // User's garage photo

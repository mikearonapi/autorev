 ...
 */
const RAW_BLOB_URL = process.env.NEXT_PUBLIC_VERCEL_BLOB_URL || 'https://abqnp7qrs0nhv5pw.public.blob.vercel-storage.com';
const BLOB_BASE_URL = RAW_BLOB_URL.replace(/\\[nr]/g, '').replace(/[\r\n]/g, '').trim();
...
export const UI_IMAGES = {
  ...
  // Legacy speedometer logo (kept for backward compatibility)
  logoTrimmed: '/images/autorev-logo-trimmed.png',
  // New wordmark logo (AR with white/lime colors on navy)
  logoWordmark: '/images/autorev-logo-wordmark.png',
};
...
/**
 * Onboarding screenshots - Using Vercel Blob CDN for optimal performance
...
export const ONBOARDING_IMAGES = {
  ...
  // ==========================================================================
  garageCard: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.png`,
  garageAddVehicle: `${BLOB_BASE_URL}/site-design/add-vehicle-search-modal.png`,
  garagePhotos: `${BLOB_BASE_URL}/site-design/photos-gallery-page.png`,
  garageSpecs: `${BLOB_BASE_URL}/site-design/vehicle-specs-performance-engine.png`,
  garageKnownIssues: `${BLOB_BASE_URL}/site-design/known-issues-priority-warnings.png`,
  
  // ==========================================================================
  // MY DATA - Performance metrics, virtual dyno, lap times
  // ==========================================================================
  dataPerformanceMetrics: `${BLOB_BASE_URL}/site-design/my-data-performance-metrics-scrolled.png`,
  dataVirtualDyno: `${BLOB_BASE_URL}/site-design/my-data-virtual-dyno-chart.png`,
  dataLapTimeEstimator: `${BLOB_BASE_URL}/site-design/my-data-track-lap-time-estimator.png`,
  dataExperienceScores: `${BLOB_BASE_URL}/site-design/performance-metrics-experience-scores.png`,
  dataPowerBreakdown: `${BLOB_BASE_URL}/site-design/power-breakdown-donut-dyno-results.png`,
  ...
  communityBuildEvoX: `${BLOB_BASE_URL}/site-design/community-build-evo-x-performance.png`,
  communityBuildRS5: `${BLOB_BASE_URL}/site-design/community-builds-feed-rs5-stormtrooper.png`,
  communityBuildMods: `${BLOB_BASE_URL}/site-design/community-build-evo-x-modifications.png`,
  ...
  alChatSuggestions: `${BLOB_BASE_URL}/site-design/al-chat-home-suggestions.png`,
  alChatThinking: `${BLOB_BASE_URL}/site-design/al-chat-thinking-state.png`,
  alChatResponse: `${BLOB_BASE_URL}/site-design/al-chat-upgrade-response.png`,
  
  // ==========================================================================
  // LEGACY - Kept for backward compatibility with other pages
  // ==========================================================================
  // Homepage mappings
  garageOverview: `${BLOB_BASE_URL}/site-design/my-garage-rs5-card.png`,
  tuningShopOverview: `${BLOB_BASE_URL}/site-design/build-upgrade-categories.png`,
  aiAlResponseMods: `${BLOB_BASE_URL}/site-design/al-chat-upgrade-response.png`,
  communityEventsList: `${BLOB_BASE_URL}/site-design/community-builds-feed-evo-x.png`,

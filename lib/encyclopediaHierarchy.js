...
const _legacyTopicsReference = {
  ...
  'tire-compound-construction': {
    ...
    modPotential: 'Tire selection should match use case. Street tires for daily driving, summer performance for spirited driving, track tires for HPDE. Use the Wheels & Tires configurator to select your compound.',

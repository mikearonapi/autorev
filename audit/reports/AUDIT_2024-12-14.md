...
>
> All findings have been addressed. See the updated documentation files for current state:
> - `DATABASE.md` — 65 tables with verified row counts
> - `API.md` — 55 routes with cron schedules
> - `COMPONENTS.md` — 53 components
> - `FEATURES.md` — Live data metrics
>
> ~~⚠️ **SUPERSEDED:** Many issues from this morning audit have been resolved. See `DOCS_SYNC_REPORT_2024-12-14.md` for current status.~~
...
| **Status** | ✅ Complete (superseded by evening sync) |
| **Auditor** | AI-Assisted |
...
|-------|-------------|--------|----------|
| 1A | Internal Link Verification | ✅ Complete | 2 broken, 1 suspicious |
| 1B | API Route Verification | ⚠️ Issues Found | 1 critical, 13 undocumented |
| 2A | Import/Export Health | ✅ Complete | 2 deprecated refs, 2 TODOs |
| 2B | Database Schema Alignment | ⚠️ Issues Found | 2 undocumented tables, 2 doc mismatches |
| 3A | Parts Catalog Integration | ✅ Complete | All flows verified |
| 3B | AL Tools Verification | ✅ Complete | All 15 tools verified |
| 4 | Cron & Background Jobs | ✅ Complete | 2 auth gaps, 1 doc mismatch |
| 5 | Security & Auth Review | ⏳ Pending | - |
| 6 | Performance Analysis | ⏳ Pending | - |
| 7 | Test Coverage Assessment | ⏳ Pending | - |
| 8 | Documentation Sync | ⏳ Pending | - |
...
| MED-004 | ✅ Reference to deleted `SOURCE_OF_TRUTH.md` | `docs/OWNER_GUIDE.md` - Fixed |
| MED-005 | ✅ Reference to deleted `docs/data-model.md` | `docs/OWNER_GUIDE.md`, `supabase/schema.sql` - Fixed |
...
|-----------|-------------|--------|
| Header.jsx | `navLinks` (6 items) | ✅ All valid |
| Footer.jsx | `mainLinks` (6 items) | ✅ All valid |
| Footer.jsx | `legalLinks` (2 items) | ✅ All valid |
| MobileBottomCta.jsx | `pageCtas` (5 configs) | ✅ All valid |
| internal/page.jsx | `TOOLS` (6 items) | ✅ All valid |
...
|-------|------------|--------------|--------|
| `/api/cars/[slug]/efficiency` | GET | GET | ✅ Match |
| `/api/cars/[slug]/safety-ratings` | GET | GET | ✅ Match |
| `/api/cars/[slug]/price-by-year` | GET | GET | ✅ Match |
| `/api/cars/[slug]/market-value` | GET | GET | ✅ Match |
| `/api/cars/[slug]/lap-times` | GET | GET | ✅ Match |
| `/api/cars/[slug]/dyno` | GET | GET | ✅ Match |
| `/api/cars/[slug]/maintenance` | GET | GET | ✅ Match |
| `/api/cars/[slug]/expert-reviews` | GET | GET | ✅ Match |
| `/api/cars/[slug]/expert-consensus` | GET | GET | ✅ Match |
| `/api/cars/[slug]/enriched` | GET | GET | ✅ Match |
| `/api/cars/[slug]/safety` | GET | GET | ✅ Match |
| `/api/cars/[slug]/fuel-economy` | GET | GET | ✅ Match |
| `/api/cars/[slug]/pricing` | GET | GET | ✅ Match |
| `/api/cars/[slug]/manual-data` | GET | GET, **POST** | ⚠️ POST undocumented |
| `/api/cars/expert-reviewed` | GET | GET | ✅ Match |

#### Parts Routes (3 documented, 3 implemented)

| Route | Doc Method | Impl Methods | Status |
|-------|------------|--------------|--------|
| `/api/parts/search` | GET | GET | ✅ Match |
| `/api/parts/popular` | GET | GET | ✅ Match |
| `/api/parts/relationships` | GET | **POST** | ❌ Mismatch (doc says GET, code is POST) |

#### Users/AL Routes (4 documented, 4 implemented)

| Route | Doc Method | Impl Methods | Status |
|-------|------------|--------------|--------|
| `/api/ai-mechanic` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/api/users/[userId]/al-conversations` | GET | GET | ✅ Match |
| `/api/users/[userId]/al-conversations/[conversationId]` | GET | GET, **DELETE**, **PATCH** | ⚠️ DELETE, PATCH undocumented |
| `/api/users/[userId]/al-credits` | GET | GET | ✅ Match |

#### VIN Routes (2 documented, 2 implemented)

| Route | Doc Method | Impl Methods | Status |
|-------|------------|--------------|--------|
| `/api/vin/decode` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/api/vin/resolve` | POST | POST | ✅ Match |

#### Internal Routes (7 documented, 7 implemented)

| Route | Doc Method | Impl Methods | Status |
|-------|------------|--------------|--------|
| `/api/internal/car-variants` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/api/internal/dyno/runs` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/api/internal/track/lap-times` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/api/internal/parts/fitments` | POST | **GET**, **PATCH** | ⚠️ GET, PATCH undocumented (no POST!) |
| `/api/internal/knowledge/ingest` | POST | POST | ✅ Match |
| `/api/internal/maintenance/variant-overrides` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/api/internal/qa-report` | GET | GET | ✅ Match |

#### Cron Routes (3 documented, 3 implemented)

| Route | Doc Method | Impl Methods | Status |
|-------|------------|--------------|--------|
| `/api/cron/schedule-ingestion` | - | GET | ⚠️ Method not specified in docs |
| `/api/cron/process-scrape-jobs` | - | GET, **POST** | ⚠️ Methods not specified in docs |
| `/api/cron/youtube-enrichment` | - | GET, **POST** | ⚠️ Methods not specified in docs |

#### Other Routes (3 documented, 3 implemented)

| Route | Doc Method | Impl Methods | Status |
|-------|------------|--------------|--------|
| `/api/contact` | POST | POST | ✅ Match |
| `/api/feedback` | POST | POST, **GET** | ⚠️ GET undocumented |
| `/auth/callback` | GET | GET (route.js) | ✅ Match |
...
|----------------|--------------|--------|
| `@/data/cars.js` | carsClient.js, alTools.js, aiMechanicService.js | ✅ Exists |
| `@/data/upgradeEducation` | alTools.js, encyclopediaData.js, educationData.js | ✅ Exists |
| `@/data/connectedTissueMatrix` | encyclopediaData.js, educationData.js, dependencyChecker.js | ✅ Exists |
| `@/data/upgradePackages.js` | dependencyChecker.js | ✅ Exists |
| `@/lib/upgrades.js` | dependencyChecker.js | ✅ Exists |
| `@/lib/embeddingUtils` | knowledgeIndexService.js, app/api/internal/knowledge/ingest | ✅ Exists |
| `./supabase.js` | partsVendorIngestionService.js, knowledgeIndexService.js | ✅ Exists |

### ✅ Deprecated File References (Resolved)

| Deprecated File | Referenced In | Status |
|-----------------|---------------|--------|
| `SOURCE_OF_TRUTH.md` | `docs/OWNER_GUIDE.md` | ✅ Fixed - Updated to point to `/docs` directory |
| `docs/data-model.md` | `docs/OWNER_GUIDE.md`, `supabase/schema.sql` | ✅ Fixed - Updated to `docs/DATABASE.md` |
...
|--------|---------|--------------|
| `lib/partsVendorIngestionService.js` | `ingestShopifyVendor`, `SHOPIFY_VENDOR_PRESETS`, `runPartsVendorIngestJob` | ✅ Used by scrapeJobService.js |
| `lib/knowledgeIndexService.js` | `ingestKnowledgeText`, `runKnowledgeIndexJob` | ✅ Used by API routes |
...
#### ✅ Verified Tables (Match DATABASE.md)

| Category | Tables | Status |
|----------|--------|--------|
| Core Car Data | `cars`, `car_variants`, `car_fuel_economy`, `car_safety_data`, `car_issues`, `car_market_pricing`, `car_market_pricing_years`, `car_price_history`, `car_dyno_runs`, `car_track_lap_times`, `car_recalls`, `car_auction_results`, `car_manual_data` | ✅ |
| Parts | `parts`, `part_fitments`, `part_pricing_snapshots`, `part_relationships`, `part_brands`, `upgrade_keys`, `upgrade_packages` | ✅ |
| User Data | `user_profiles`, `user_favorites`, `user_projects`, `user_feedback`, `user_vehicles`, `user_service_logs`, `user_project_parts`, `user_compare_lists`, `user_activity` | ✅ |
| Maintenance | `vehicle_maintenance_specs`, `vehicle_service_intervals`, `vehicle_known_issues` | ✅ |
| AL/AI | `al_conversations`, `al_messages`, `al_user_credits`, `al_usage_logs`, `al_credit_purchases` | ✅ |
| Knowledge | `source_documents`, `document_chunks` | ✅ |
| YouTube | `youtube_videos`, `youtube_video_car_links`, `youtube_channels`, `youtube_ingestion_queue` | ✅ |
| Track | `track_venues`, `track_layouts` | ✅ |
| System | `scrape_jobs`, `fitment_tag_mappings`, `leads`, `car_variant_maintenance_overrides` | ✅ |

#### ⚠️ Tables in Code NOT in DATABASE.md
...
### ⚠️ Column Mismatches (Documentation Errors)

#### `part_relationships` Table

| Column | DATABASE.md Says | Actual Schema | Code Uses |
|--------|------------------|---------------|-----------|
| FK to part A | `part_id_a` | `part_id` | `part_id` ✅ |
| FK to part B | `part_id_b` | `related_part_id` | `related_part_id` ✅ |
| Relation type | `relationship_type` | `relation_type` | `relation_type` ✅ |
...
| Column | DATABASE.md Says | Actual Schema | Code Uses |
|--------|------------------|---------------|-----------|
| FK to source | `source_document_id` | `document_id` | `document_id` ✅ |
...
```
✅ id, name, brand_name, part_number, category, description
✅ quality_tier, street_legal, is_active, source_urls
✅ attributes (JSONB), confidence, brand_id
```

#### `part_fitments` Table Columns Verified

```
✅ id, part_id, car_id, car_variant_id
✅ fitment_notes, requires_tune, install_difficulty
✅ estimated_labor_hours, verified, confidence
✅ source_url, metadata
```
...
```
✅ id, part_id, vendor_name, vendor_url, product_url
✅ currency, price_cents, in_stock, recorded_at, metadata
```
...
```
source_documents:
✅ id, source_type, source_url, source_title, license
✅ retrieved_at, checksum, raw_text, raw_json, metadata

document_chunks:
✅ id, document_id (NOT source_document_id), car_id, car_slug
✅ chunk_index, chunk_text, chunk_tokens, topic
...
**Status:** ✅ Complete  
**Verified:** API → Service → Database → Frontend

### Data Flow Diagram

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                         PARTS CATALOG DATA FLOW                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌──────────────────┐                                                       │
│  │  Tuning Shop     │                                                       │
...
│           ▼                                                                 │
│  ┌──────────────────┐                                                       │
│  │  UpgradeCenter   │◄─── Parts Finder (Beta)                               │
│  │  (component)     │                                                       │
│  └────────┬─────────┴─────────────────┐                                     │
│           │                           │                                     │
│           ▼                           ▼                                     │
│  ┌──────────────────┐       ┌──────────────────┐                            │
│  │ /api/parts/search│       │ /api/parts/      │                            │
│  │ (GET)            │       │ relationships    │                            │
│  └────────┬─────────┘       │ (POST)           │                            │
│           │                 └────────┬─────────┘                            │
│           │                          │                                      │
...
|-------|--------|------------|----------------|-------------|
| `/api/parts/search` | GET | ✅ Matches API.md | ✅ try/catch + logging | parts, part_fitments, part_pricing_snapshots, cars, car_variants |
| `/api/parts/popular` | GET | ✅ Matches API.md | ✅ try/catch + logging | cars, part_fitments, parts, part_pricing_snapshots |
| `/api/parts/relationships` | **POST** | ❌ API.md says GET | ✅ try/catch + logging | part_relationships, parts |
...
```
✅ Matches API.md response shape

### Frontend Integration

| Component | Parts API Usage | Loading State | Error State |
|-----------|----------------|---------------|-------------|
| `UpgradeCenter.jsx` | `/api/parts/search`, `/api/parts/relationships` | ✅ `partsLoading` | ✅ `partsError` |
| `SavedBuildsProvider.jsx` | `userDataService` → `user_project_parts` | ✅ `isLoading` | ✅ Error handling |
...
|---|-----------|--------|--------------|-------------|----------------|
| 1 | `search_cars` | ✅ | ✅ | Free+ | cars (via RPC or local data) |
| 2 | `get_car_details` | ✅ | ✅ | Free+ | cars, car_issues, car_known_issues |
| 3 | `get_car_ai_context` | ✅ | ✅ | Free+ | RPC: `get_car_ai_context` |
| 4 | `get_expert_reviews` | ✅ | ✅ | Enthusiast+ | youtube_video_car_links, youtube_videos |
| 5 | `get_known_issues` | ✅ | ✅ | Enthusiast+ | car_issues, car_known_issues |
| 6 | `compare_cars` | ✅ | ✅ | Enthusiast+ | local car data |
| 7 | `search_encyclopedia` | ✅ | ✅ | Enthusiast+ | lib/encyclopediaData.js |
| 8 | `get_upgrade_info` | ✅ | ✅ | Enthusiast+ | data/upgradeEducation.js |
| 9 | `search_forums` | ✅ | ✅ | Enthusiast+ | Placeholder (returns suggestions) |
| 10 | `search_parts` | ✅ | ✅ | Enthusiast+ | parts, part_fitments, part_pricing_snapshots |
| 11 | `get_maintenance_schedule` | ✅ | ✅ | Enthusiast+ | RPCs: `get_car_maintenance_summary`, `get_car_maintenance_summary_variant` |
| 12 | `search_knowledge` | ✅ | ✅ | Enthusiast+ | RPC: `search_document_chunks` (uses `document_id`) |
| 13 | `get_track_lap_times` | ✅ | ✅ | Enthusiast+ | RPC: `get_car_track_lap_times` → car_track_lap_times |
| 14 | `get_dyno_runs` | ✅ | ✅ | Enthusiast+ | RPC: `get_car_dyno_runs` → car_dyno_runs |
| 15 | `recommend_build` | ✅ | ✅ | Tuner only | parts, part_fitments, part_pricing_snapshots |
...
**RPC Chain:**
- `get_car_maintenance_summary_variant(p_variant_key)` → checks `car_variant_maintenance_overrides` → falls back to `vehicle_maintenance_specs`
- `get_car_maintenance_summary(p_car_slug)` → directly queries `vehicle_maintenance_specs`
...
| Enthusiast | 14 tools | `alConfig.js:135-150` |
...
|-------|-------------|-----|------|----------|-----------|
| `/api/cron/process-scrape-jobs` | ✅ | ✅ | ✅ | ✅ CRON_SECRET + x-vercel-cron | ⚠️ CRON_SECRET only |
| `/api/cron/schedule-ingestion` | ✅ | ✅ | ❌ | ✅ CRON_SECRET + x-vercel-cron | N/A |
| `/api/cron/youtube-enrichment` | ✅ | ✅ | ✅ | ⚠️ CRON_SECRET only | ⚠️ Delegates to GET |

### Security Verification

#### ✅ Secure: `schedule-ingestion`
...
#### ✅ Secure: `process-scrape-jobs` GET
...
#### ⚠️ Issue: `process-scrape-jobs` POST
...
#### ⚠️ Issue: `youtube-enrichment` GET (HIGH-006)
...
│  │    (vercel.json → Triggers GET with x-vercel-cron: true header)        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│           │                    │                    │                       │
│           ▼                    ▼                    ▼                       │
│  ┌──────────────┐    ┌──────────────┐    ┌────────────────┐                 │
│  │ process-     │    │ schedule-    │    │ youtube-       │                 │
│  │ scrape-jobs  │    │ ingestion    │    │ enrichment     │                 │
│  │ (every 15m)  │    │ (Sun 2am)    │    │ (Mon 4am)      │                 │
│  └──────┬───────┘    └──────┬───────┘    └───────┬────────┘                 │
│         │                   │                    │                          │
│         ▼                   ▼                    │                          │
│  ┌──────────────────────────────────┐            │                          │
...
│  ┌──────────────────────────────────┐            │                          │
│  │         scrape_jobs table        │            │                          │
│  │  • id, car_slug, job_type        │            │                          │
│  │  • status, priority              │            │                          │
│  │  • scheduled_for, job_payload    │            │                          │
│  └──────────────────────────────────┘            │                          │
│                                                  │                          │
│         ┌────────────────────────────────────────┘                          │
│         │                                                                   │
│         ▼                                                                   │
│  ┌──────────────────────────────────┐    ┌──────────────────────────────┐   │
│  │   YouTube Pipeline (Standalone)  │    │   Job Type Handlers          │   │
│  │  • youtube_channels              │    │  • PARTS_VENDOR_INGEST       │   │
│  │  • youtube_videos                │    │    → partsVendorIngestion    │   │
│  │  • youtube_video_car_links       │    │  • KNOWLEDGE_INDEX           │   │
│  │  • cars (consensus update)       │    │    → knowledgeIndexService   │   │
│  └──────────────────────────────────┘    │  • FULL_ENRICH/PRICING_ONLY  │   │
│                                          │    → dataAggregator          │   │
│  External APIs:                          │    → enrichedDataService     │   │
│  • YouTube Data API                      └──────────────────────────────┘   │
...
|-------|-----------|---------|--------------|-------------|
| process-scrape-jobs GET | ✅ | ✅ `console.log/error` | 401, 500 | ✅ In service |
| process-scrape-jobs POST | ✅ | ✅ `console.error` | 400, 401, 500 | N/A |
| schedule-ingestion | ✅ | ✅ `console.error` | 401, 500 | N/A |
| youtube-enrichment | ✅ | ✅ `console.log/error` | 401, 500 | ❌ No retry |
...
```markdown
### `upgrade_education` — Upgrade educational content
| Status | **49 rows** |
|--------|------------|
...
```markdown
### `car_known_issues` — Legacy known issues
| Status | **89 rows** |
|--------|------------|
...
- Change `part_id_a` → `part_id`
- Change `part_id_b` → `related_part_id`
- Change `relationship_type` → `relation_type`

**`document_chunks` (line ~318):**
- Change `source_document_id` → `document_id`
...
|----|----------|-------------|-------|--------|
| CRIT-001 | 🔴 Critical | Create `/api/cars/route.js` for car list endpoint | 1B | Open |
| HIGH-001 | 🟠 High | Fix broken link in `app/internal/qa/page.jsx:127` | 1A | Open |
| HIGH-002 | 🟠 High | Fix broken link in `app/garage/compare/page.jsx:163` | 1A | Open |
| HIGH-003 | 🟠 High | Fix API.md: `/api/parts/relationships` is POST not GET | 1B | Open |
| HIGH-004 | 🟠 High | Fix DATABASE.md: `part_relationships` column names | 2B | Open |
| HIGH-005 | 🟠 High | Fix DATABASE.md: `document_chunks.document_id` | 2B | Open |
| HIGH-006 | 🟠 High | Add x-vercel-cron check to youtube-enrichment | 4 | Open |
| MED-001 | 🟡 Medium | Document 13 undocumented API methods in API.md | 1B | Open |
| MED-002 | 🟡 Medium | Add `upgrade_education` table to DATABASE.md | 2B | Open |
| MED-003 | 🟡 Medium | Add `car_known_issues` table to DATABASE.md | 2B | Open |
| MED-004 | 🟡 Medium | Remove `SOURCE_OF_TRUTH.md` refs from OWNER_GUIDE.md | 2A | ✅ Resolved |
| MED-005 | 🟡 Medium | Remove `docs/data-model.md` ref from OWNER_GUIDE.md | 2A | ✅ Resolved |
| MED-006 | 🟡 Medium | Update API.md cron schedules to match vercel.json | 4 | Open |
| MED-007 | 🟡 Medium | Add x-vercel-cron fallback to process-scrape-jobs POST | 4 | Open |
| LOW-001 | 🟢 Low | Verify `/encyclopedia#systems` anchor exists | 1A | Open |
| LOW-002 | 🟢 Low | Address TODO in `lib/userDataService.js:385` | 2A | Open |
| LOW-003 | 🟢 Low | Address TODO in `lib/alTools.js:1427` (Exa API) | 2A | Open |

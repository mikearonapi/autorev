...
| 4 | `get_expert_reviews` | ✅ | ✅ | Collector+ | youtube_video_car_links, youtube_videos |
| 5 | `get_known_issues` | ✅ | ✅ | Collector+ | car_issues, car_known_issues |
| 6 | `compare_cars` | ✅ | ✅ | Collector+ | local car data |
| 7 | `search_encyclopedia` | ✅ | ✅ | Collector+ | lib/encyclopediaData.js |
| 8 | `get_upgrade_info` | ✅ | ✅ | Collector+ | data/upgradeEducation.js |
| 9 | `search_forums` | ✅ | ✅ | Collector+ | Placeholder (returns suggestions) |
| 10 | `search_parts` | ✅ | ✅ | Collector+ | parts, part_fitments, part_pricing_snapshots |
| 11 | `get_maintenance_schedule` | ✅ | ✅ | Collector+ | RPCs: `get_car_maintenance_summary`, `get_car_maintenance_summary_variant` |
| 12 | `search_knowledge` | ✅ | ✅ | Collector+ | RPC: `search_document_chunks` (uses `document_id`) |
| 13 | `get_track_lap_times` | ✅ | ✅ | Collector+ | RPC: `get_car_track_lap_times` → car_track_lap_times |
| 14 | `get_dyno_runs` | ✅ | ✅ | Collector+ | RPC: `get_car_dyno_runs` → car_dyno_runs |

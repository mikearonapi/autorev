#!/usr/bin/env node
/**
 * Seed car shows (Carlisle, Goodguys, major concours) for 2026
 */
...
async function loadEventData() {
  const dataPath = join(__dirname, '..', 'data', 'car-shows-2026.json');
...
async function main() {
  ...
  console.log('🚗 Seeding car shows for 2026...\n');
  ...
  for (const event of events) {
    const { event_type, brand_affinity, organizer, ...eventData } = event;

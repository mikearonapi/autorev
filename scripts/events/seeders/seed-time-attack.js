#!/usr/bin/env node
/**
 * Seed time attack events (GTA, GridLife) for 2026
 */
...
async function loadEventData() {
  const dataPath = join(__dirname, '..', 'data', 'time-attack-2026.json');
...
async function main() {
  ...
  console.log('⏱️ Seeding time attack events for 2026...\n');

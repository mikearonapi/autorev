#!/usr/bin/env node
/**
 * Seed industry events (auto shows, SEMA, PRI) for 2026
 */
...
async function loadEventData() {
  const dataPath = join(__dirname, '..', 'data', 'industry-events-2026.json');
...
async function main() {
  ...
  console.log('🏭 Seeding industry events for 2026...\n');

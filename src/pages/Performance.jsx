 ...
 * Performance Page
 * 
 * Standalone page for the Performance HUB. Users can select a car
 * and then view/interact with the Performance HUB for that car.
 */

import React, { useState, useEffect, useMemo } from 'react';
import { Link, useSearchParams } from 'react-router-dom';
import styles from './Performance.module.css';
import { fetchCars } from '../api/carsClient.js';
import { carData as localCarData, tierConfig } from '../data/cars.js';
import PerformanceHub from '../components/PerformanceHub';
import { supportsPerformanceHub } from '../lib/performance.js';
...
export default function Performance() {
  ...
  useEffect(() => {
    if (selectedCarSlug) {
      setSearchParams({ car: selectedCarSlug });
    } else {
      setSearchParams({});
    }
  }, [selectedCarSlug, setSearchParams]);
        ...
        <div className={styles.container}>
          <div className={styles.infoCard}>
            ...
            <div className={styles.infoLinks}>
              <Link to="/advisory" className={styles.infoLink}>
                Browse the Car Selector →
              </Link>
              <Link to="/upgrades" className={styles.infoLink}>

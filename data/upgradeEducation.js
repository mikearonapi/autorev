...
export const upgradeDetails = {
  ...
  'fuel-system-upgrade': {
    ...
    riskLevel: 'low',
    pros: [
      'Removes fuel delivery limitation',
      'Required for serious power builds',
      'Supports E85 conversion',
      'Improves fuel atomization with larger injectors',
    ],
    cons: [
      'Expensive',
      'Requires professional tuning',
      'No gains without other power mods',

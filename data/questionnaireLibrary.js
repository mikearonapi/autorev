...
export const QUESTIONNAIRE_LIBRARY = [
  ...
  },
  {
    id: 'vehicle_era',
    category: 'vehicle_preferences',
    question: 'What eras of cars do you enjoy?',
    hint: 'Select all that apply',
    type: 'multi',
    maxSelections: 4,
    options: [
  ...
  },
  {
    ...
    category: 'vehicle_preferences',
    question: 'What drivetrains do you enjoy?',
    hint: 'Select all that apply',
    type: 'multi',
    maxSelections: 3,
    options: [
  ...
  },
  {
    ...
    category: 'vehicle_preferences',
    question: 'What type of engine aspiration do you appreciate?',
    hint: 'Select all that apply',
    type: 'multi',
    maxSelections: 3,
    options: [
  ...
  },
  {
    ...
    category: 'vehicle_preferences',
    question: 'What engines do you love?',
  ...
  },
  {
    id: 'dream_car',
    category: 'vehicle_preferences',
    question: 'What categories describe your dream cars?',
    hint: 'Select all that make you dream',
    type: 'multi',
    maxSelections: 3,
    options: [
  ...
  },
  {
    id: 'data_logging',
    category: 'car_knowledge',
    question: 'What data logging tools do you use?',
    hint: 'Select all that apply',
    type: 'multi',
    maxSelections: 3,
    options: [

...
export const nodes = {
  ...
  'powertrain.boost_level': {
    ...
    system: 'powertrain',
    name: 'Boost Level',
    description: 'Amount of boost pressure from turbo/supercharger',
    unit: 'psi',
  ...
  'powertrain.timing_advance': {
    ...
    description: 'Ignition timing advance across the RPM range',
    unit: 'degrees',
  },
  'powertrain.air_fuel_ratio': {
    ...
    system: 'powertrain',
    name: 'Air/Fuel Ratio',
    description: 'Combustion mixture ratio (stoich is 14.7:1)',
    unit: 'ratio',
  },
  'powertrain.cylinder_pressure': {
    ...
    description: 'Peak combustion pressure in cylinders',
    unit: 'psi',
  },
  'powertrain.torque_output': {
    ...
    system: 'powertrain',
    name: 'Torque Output',
    description: 'Engine torque at the crank',
    unit: 'lb-ft',
  },
  'powertrain.hp_output': {
    ...
    description: 'Engine power at the crank',
    unit: 'hp',
  },
  'powertrain.rev_limit': {
    ...
    system: 'powertrain',
    name: 'Rev Limit',
    description: 'Maximum safe engine RPM',
    unit: 'rpm',
  },
  'powertrain.bottom_end_strength': {
    ...
    description: 'Strength margin of pistons, rods, crank, and block for high power/boost',
    unit: 'rating',
  },
  'powertrain.oiling_system_margin': {
    ...
    description: 'Headroom in the engine oiling system under sustained G-loads and heat',
    unit: 'rating',
  },
  ...
  'fueling.injector_capacity': {
    ...
    description: 'Maximum fuel flow from injectors',
    unit: 'cc/min',
  },
  'fueling.lpfp_capacity': {
    ...
    description: 'In-tank fuel pump flow capacity',
    unit: 'lph',
  },
  'fueling.hpfp_capacity': {
    ...
    description: 'Direct injection pump flow capacity',
    unit: 'lph',
  },
  'fueling.fuel_pressure': {
    ...
    description: 'Pressure in the fuel rail',
    unit: 'psi',
  },
  'fueling.fuel_octane': {
    ...
    system: 'fueling',
    name: 'Fuel Octane',
    description: 'Required fuel octane rating',
    unit: 'AKI',
  },
  ...
  'ignition.spark_energy': {
    ...
    system: 'ignition',
    name: 'Spark Energy',
    description: 'Energy delivered by ignition coils',
    unit: 'mJ',
  },
  'ignition.plug_heat_range': {
    ...
    description: 'Thermal rating of spark plugs (colder = higher boost)',
    unit: 'heat range',
  },
  'ignition.knock_threshold': {
    ...
    description: 'Detonation safety margin',
    unit: 'degrees',
  },
  'ignition.coil_dwell': {
    ...
    description: 'Charge time for ignition coils',
    unit: 'ms',
  },
  ...
  'exhaust.backpressure': {
    ...
    description: 'Resistance to exhaust gas flow',
    unit: 'psi',
  },
  'exhaust.flow_capacity': {
    ...
    description: 'Maximum exhaust volume flow rate',
    unit: 'cfm',
  },
  'exhaust.cat_converter_state': {
    ...
    description: 'Stock, high-flow, or deleted cat',
    unit: 'state',
  },
  'exhaust.header_type': {
    ...
    system: 'exhaust',
    name: 'Header Type',
    description: 'Stock manifold, shorty headers, or long-tube headers',
    unit: 'type',
  },
  ...
  'induction.turbo_size': {
    ...
    system: 'induction',
    name: 'Turbo Size',
    description: 'Compressor and turbine wheel sizing',
    unit: 'mm',
  ...
  'induction.wastegate_capacity': {
    ...
    description: 'Maximum boost the wastegate can regulate',
    unit: 'psi',
    applicableEngines: ['Turbo'],
  },
  'induction.bov_capacity': {
    ...
    system: 'induction',
    name: 'Blow-Off Valve',
    description: 'Compressor surge protection capacity',
    unit: 'psi',
    applicableEngines: ['Turbo'],
  },
  ...
  'brakes.pad_temp_rating': {
    ...
    description: 'Maximum operating temperature of brake pads',
    unit: '°F',
  },
  'brakes.rotor_thermal_mass': {
    ...
    description: 'Heat absorption capacity of brake rotors',
    unit: 'kJ',
  },
  'brakes.rotor_size': {
    ...
    system: 'brakes',
    name: 'Rotor Diameter',
    description: 'Brake rotor diameter',
    unit: 'mm',
  },
  'brakes.caliper_piston_area': {
    ...
    description: 'Total piston area for clamping force',
    unit: 'sq in',
  },
  'brakes.fluid_boiling_point': {
    ...
    description: 'Dry boiling point of brake fluid',
    unit: '°F',
  },
  'brakes.line_expansion': {
    ...
    description: 'Pedal feel firmness (rubber vs SS)',
    unit: 'type',
  },
  'brakes.brake_bias': {
  ...
  'brakes.abs_calibration': {
    ...
    description: 'ABS intervention thresholds and behavior',
    unit: 'type',
  },
  ...
  'suspension.spring_rate_front': {
    ...
    description: 'Spring stiffness at front axle',
    unit: 'lb/in',
  },
  'suspension.spring_rate_rear': {
    ...
    description: 'Spring stiffness at rear axle',
    unit: 'lb/in',
  },
  'suspension.damper_range': {
    ...
    description: 'Effective stroke range of dampers',
    unit: 'mm',
  },
  'suspension.ride_height': {
    ...
    system: 'suspension',
    name: 'Ride Height',
    description: 'Ground clearance / chassis height',
    unit: 'inches',
  },

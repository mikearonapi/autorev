 ...
 *
 *   <InfoTooltip topicKey="hp" carName="BMW M3" carId="123">
 ...
 * @param {string} carId - Optional car ID for AL context
...
export default function InfoTooltip({
  topicKey,
  children,
  carName: _carName, // Reserved for future AL context
  carId: _carId, // Reserved for future AL context
  className = '',
  variant = 'inline',
}) {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={handleClose} title={content.title} size="sm">
...
export function InfoTooltipIcon({
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title={content.title} size="sm">
        <div className={styles.modalContent}>
          <section className={styles.section}>
            <h4 className={styles.sectionTitle}>What is it?</h4>
            <p className={styles.sectionText}>{content.definition}</p>

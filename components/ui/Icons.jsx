 ...
 * Icons are React components that accept a `size` prop.
 *
 * Usage:
...
export const Icons = {
  ...
  slideshow: ({ size = 20 }) => (
    ...
    >
      ...
      <path d="M8 21h8" />
      <path d="M12 17v4" />
      <polygon points="10 7 10 13 15 10 10 7" fill="currentColor" stroke="none" />
    </svg>
  ),
  ...
  // ---------------------------------------------------------------------------
  // ADDITIONAL ICONS (Phase 3 migration)
  // ---------------------------------------------------------------------------
...
export const CompareIcon = Icons.compare;

...
export default function AuthModal({ isOpen, onClose, defaultMode = 'signin' }) {
  ...
  const { loginWithGoogle, loginWithFacebook, loginWithEmail, signUp, isSupabaseConfigured } =
    useAuth();
  ...
  // Handle Facebook sign in (disabled - kept for future use)
      ...
      <div className={styles.overlay} onClick={handleBackdropClick} data-overlay-modal>
        <div className={styles.modal} role="dialog" aria-modal="true">
          ...
          <div className={styles.successView}>
            ...
            <p className={styles.helpText}>The link expires in 24 hours.</p>
            <button className={styles.primaryBtn} onClick={() => setView('signin')}>
              Back to Sign In
            </button>
          </div>
    ...
    return createPortal(
      <div className={styles.overlay} onClick={handleBackdropClick} data-overlay-modal>
        <div className={styles.modal} role="dialog" aria-modal="true">
          ...
          <div className={styles.infoBox}>Enter your email and we'll send you a reset link.</div>
              ...
              {password && (
                <div className={styles.strengthRow}>
                  ...
                  <span
                    style={{
                      color:
                        strengthColors[passwordValidation.strength - 1] || 'var(--color-gray-400)',
                    }}
                  >
                    {passwordValidation.strength > 0
                      ? strengthLabels[passwordValidation.strength - 1]
                      : ''}
                  </span>
                </div>
              )}

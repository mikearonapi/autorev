...
/**
 * Simple, monochrome icons for clean UI
 ...
 * Design: Clean grid matching BrandsStep aesthetic
 */
export default function ReferralStep({ className, formData, updateFormData }) {
  ...
  const firstName = formData.display_name?.split(' ')[0];
    ...
    <div className={`${styles.container} ${className || ''}`}>
      ...
      <div className={styles.header}>
        <h2 className={styles.title}>
          {firstName ? `Thanks, ${firstName}!` : 'One quick question'}
        </h2>
        <p className={styles.subtitle}>
          How did you discover AutoRev?
        </p>
      </div>
      ...
      <div className={styles.optionGrid}>
        {REFERRAL_OPTIONS.map((option) => (
          <button
            ...
            type="button"
            aria-pressed={formData.referral_source === option.value}
          >

...
export default function StickyCarHeader({
  ...
  // Get car image - use provided URL, database URL, or fallback via getCarHeroImage
  const imageUrl = carImageUrl || car.hero_image_url || car.thumbnail_url || getCarHeroImage(car);

...
export default function ReferralPanel({ userId }) {
  ...
  const getProgress = () => {
    ...
    return {
      ...
      next: nextMilestone,
      percentage,
      achieved: achieved.map((k) => MILESTONES.find((m) => m.key === k)),
    };
  };
    ...
    <div className={styles.panel}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerText}>
          ...
          <p className={styles.creditExplainer}>
            That's enough for <strong>100+ AI conversations</strong> with AL about cars, builds, and
            buying advice
          </p>
        </div>
      </div>
      ...
      <div className={styles.shareSection}>
        ...
        <div className={styles.shareActions}>
          <button onClick={() => setShowEmailModal(true)} className={styles.emailActionButton}>
            <EmailIcon />
        ...
        {progress.next ? (
          <div className={styles.progressContainer}>
            ...
            <span className={styles.progressNeeded}>
              {progress.next.friends - progress.current} more friend
              {progress.next.friends - progress.current !== 1 ? 's' : ''} to go!
            </span>
          </div>
        ) : (
              ...
              <div key={referral.id} className={styles.referralItem}>
                <div className={styles.referralInfo}>
                  ...
                  <span className={styles.referralDate}>
                    Invited {formatEventDate(referral.created_at)}
                  </span>
                </div>
                <div className={styles.referralActions}>
                  {referral.status === 'pending' ? (
                    ...
                    <>
                      ...
                      <span className={styles.creditsEarned}>
                        +{referral.credits_earned || 200}
                      </span>
                    </>
                  )}
                </div>
          ...
          >
            <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
              ...
              <p className={styles.modalDescription}>
                We'll send them a beautiful invite with your referral link. They'll get{' '}
                <strong>200 bonus credits</strong> when they join!
              </p>

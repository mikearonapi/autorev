  ...
  const popupContent = (
    <div className={styles.overlay} onClick={handleBackdropClick} data-overlay-modal>
      <div className={styles.popup} role="dialog" aria-modal="true">
        ...
        <div
          className={`${styles.content} ${isAnimating ? (slideDirection === 'next' ? styles.slideOutLeft : styles.slideOutRight) : styles.slideIn}`}
        >
          {/* Icon - centered */}
          {step.icon && <div className={styles.iconWrapper}>{step.icon}</div>}
 ...
 *
 * Maps directly to the 5 Garage tabs: Specs → Build → Parts → Install → Photos
 ...
 * 4. Parts - Find and buy the right parts
 * 5. Install - DIY or find a shop
 * 6. Photos - Document and share your build
 */
export const garageOnboardingSteps = [
  {
    ...
    description:
      "Your command center for building the car you've always wanted. Research, plan, and track every modification—all in one place.",
    features: [
  ...
  },
  {
    ...
    title: 'Specs',
    description:
      'Everything you need to know about your car. Factory specs, performance ratings, tuning potential, and maintenance schedules.',
    features: [
  ...
  },
  {
    ...
    title: 'Build',
    description:
      "Configure your perfect build. Select from curated upgrade categories and see exactly what's possible for your car.",
    features: [
  ...
  },
  {
    ...
    title: 'Parts',
    description:
      'Turn your build plan into a shopping list. Get AL-powered part recommendations with pricing and compatibility info.',
    features: [
  ...
  },
  {
    ...
    title: 'Install',
    description:
      'Choose your path: DIY with tool lists and install videos, or find a trusted service center near you.',
    features: [
  ...
  },
  {
    ...
    title: 'Photos',
    description:
      'Document your build journey. Upload photos, track your progress, and share your finished build with the community.',
    features: [
...
export const dataOnboardingSteps = [
  {
    ...
    description:
      'Your performance data hub. Get estimates for what your mods should deliver, then log your actual results to compare predictions vs. reality.',
    features: [
  ...
  },
  {
    ...
    title: 'Virtual Dyno',
    description:
      'See estimated HP and torque curves based on your modifications. Stock vs. modified side-by-side, with interactive RPM exploration.',
    features: [
  ...
  },
  {
    ...
    description:
      'Been to the dyno? Log your actual numbers to compare against our estimates. Track your power progression over time.',
    features: [
  ...
  },
  {
    ...
    description:
      'Estimate lap times at real tracks based on your build. Powered by 3,800+ real lap times across 340+ tracks.',
    features: [
  ...
  },
  {
    ...
    description:
      'Hit the track? Log your actual lap times to compare against estimates. Track your personal bests and improvement over time.',
    features: [

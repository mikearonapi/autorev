...
import styles from './sports-car-advisory.module.css';
import { carData as localCarData, categories, tierConfig, recommendationTypes } from './src/data/cars.js';
import { fetchCars } from './src/api/carsClient.js';
import { 
                        ...
                        <div className={styles.expandedRow}>
                          ...
                          {car.slug && (
                            <div className={styles.expandedActions}>
                              <Link to={`/cars/${car.slug}`} className={styles.viewProfileButton}>

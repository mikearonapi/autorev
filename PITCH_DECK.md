...
```
DISCOVER → RESEARCH → BUY → OWN → MODIFY
```
...
**Plus: AL — an AI assistant with real automotive knowledge, not hallucinations.**
...
|---------|-------------|--------|
| **Car Database** | 98 sports cars ($25K–$200K+) with 139 data columns each | Free |
...
**All data is real, verified, and sourced — never hallucinated.**
...
- 500K enthusiasts actively shopping or modifying in Year 1–3 target segments:
...
2. YouTube has democratized expert knowledge — needs aggregation
...
- AI costs ~$0.01–0.02 per conversation (Claude Sonnet 4)
- Data maintenance is one-time per car, scales across all users
- High gross margins once data asset is built

---

## Page 7: Competitive Moat — The Data Asset

### Our database doesn't exist anywhere else

| Data Asset | Records | Why It Matters |
|------------|---------|----------------|
| **Enthusiast Scores** | 98 cars × 7 scores | Subjective scores (sound, track, reliability) — not available from any API |
...
| **Known Issues** | 154 documented | Sourced from forums, owner reports — not manufacturer data |
| **Maintenance Specs** | 98 cars × 130 columns | Oil, coolant, brake fluid, tire specs per car |
...
1. **Curation takes time** — 18+ months of manual data work
2. **AI needs structure** — Raw data doesn't help; our schema enables AL
3. **Network effects** — More users = more dyno/lap submissions = better data
4. **First-mover** — No one else building enthusiast-specific AI
...
- ✅ Full platform functional (beta)
- ✅ All features unlocked during beta for validation
- ✅ Data pipeline operational (NHTSA, EPA, YouTube APIs)
...
### [Team section — customize with your information]
...
- Enthusiasts ourselves — understand the user deeply

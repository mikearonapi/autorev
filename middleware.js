...
export async function middleware(request) {
  ...
  if (refCode && refCode.length === 8 && !user) {
    ...
    // Referral code stored successfully
  }
  ...
  const cspDirectives = [
    ...
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://va.vercel-scripts.com https://www.googletagmanager.com https://www.google-analytics.com https://*.posthog.com https://connect.facebook.net https://static.cloudflareinsights.com",
    // Styles: self and inline (for CSS-in-JS and dynamic styles)
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    // Images: self, data URIs, blob, plus trusted image hosts
    "img-src 'self' data: blob: https://*.supabase.co https://*.blob.vercel-storage.com https://*.googleusercontent.com https://images.unsplash.com https://i.ytimg.com https://www.google-analytics.com https://www.facebook.com",
    // Fonts: self and Google Fonts
    "font-src 'self' https://fonts.gstatic.com data:",
    // Connect: API calls to self and external services
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://api.anthropic.com https://api.openai.com https://va.vercel-scripts.com https://www.google-analytics.com https://*.vercel-insights.com https://*.posthog.com https://*.sentry.io https://connect.facebook.net https://*.facebook.com https://cloudflareinsights.com",

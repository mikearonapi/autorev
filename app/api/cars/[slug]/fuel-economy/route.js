...
async function handleGet(request, { params }) {
  ...
  try {
      ...
      fuelEconomy: {
        ...
        costs: {
          ...
          fuelPrices: fuelPrices
            ...
            : null,
          // 5-year estimate
          fiveYearFuelCost: fuelData.annualCostEstimate ? fuelData.annualCostEstimate * 5 : null,
        },
      },
    ...
    return NextResponse.json({ error: 'Failed to fetch fuel economy data' }, { status: 500 });
  }
}

export const GET = withErrorLogging(handleGet, {
  route: 'cars/[slug]/fuel-economy',
  feature: 'browse-cars',
});

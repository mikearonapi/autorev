...
async function handlePatch(request, { params }) {
  ...
  if (body.battery_installed_date !== undefined)
    updates.battery_installed_date = body.battery_installed_date;
  if (body.storage_mode !== undefined) updates.storage_mode = body.storage_mode;
  if (body.tire_installed_date !== undefined)
    updates.tire_installed_date = body.tire_installed_date;
  ...
  if (body.registration_due_date !== undefined)
    updates.registration_due_date = body.registration_due_date;
  if (body.inspection_due_date !== undefined)
    updates.inspection_due_date = body.inspection_due_date;
  if (body.last_inspection_date !== undefined)
    updates.last_inspection_date = body.last_inspection_date;
  if (body.last_oil_change_date !== undefined)
    updates.last_oil_change_date = body.last_oil_change_date;
  if (body.last_oil_change_mileage !== undefined)
    updates.last_oil_change_mileage = body.last_oil_change_mileage;
  ...
  // Hide stock image preference (for garage gallery)
  if (body.hide_stock_image !== undefined) updates.hide_stock_image = body.hide_stock_image;
  ...
  return NextResponse.json({
    success: true,
    vehicle: data,
    message: updates.specs_confirmed
      ? 'Specs confirmed successfully!'
...
export const GET = withErrorLogging(handleGet, {
  route: 'users/vehicles/[vehicleId]',
  feature: 'garage',
});

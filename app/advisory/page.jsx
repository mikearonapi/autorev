...
export const metadata = {
  ...
  description: 'Find your perfect sports car based on sound, track capability, reliability, value, and more. 35+ vehicles from $25K to $100K with real owner insights.',
};
          ...
          <div className={styles.ctaCard}>
            <div className={styles.ctaContent}>
              ...
              <div className={styles.ctaButtons}>
                <Button href="/upgrades" variant="primary" size="lg">
                  Plan Upgrades
                </Button>

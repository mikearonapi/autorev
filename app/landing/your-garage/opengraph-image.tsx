...
export const alt = 'AutoRev My Garage - Your Car Reference Hub';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image() {
  const heroImageData = readFileSync(join(process.cwd(), 'public/images/onboarding/garage-02-details.png'));
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Everything About
              <br />
              <span style={{ color: BRAND.gold }}>Your Car.</span>
              <br />
              One Place.
            </h1>
            ...
            >
              Maintenance specs, safety ratings, known issues — organized around YOUR specific vehicle.
            </p>
        ...
        >
          ...
          >
            autorev.app/landing/your-garage
          </span>
        </div>

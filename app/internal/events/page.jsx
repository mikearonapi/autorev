          ...
          submissions.map(sub => (
            <div key={sub.id} className={styles.submissionCard}>
              ...
              <div className={styles.submissionMeta}>
                <span>
                  {Icons.calendar} {formatDate(sub.start_date)}
                  {sub.end_date && sub.end_date !== sub.start_date && ` - ${formatDate(sub.end_date)}`}
                </span>
                <span>{Icons.mapPin} {sub.city}{sub.state ? `, ${sub.state}` : ''}</span>
                <span>{Icons.tag} {sub.event_type_slug}</span>
              </div>

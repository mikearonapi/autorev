...
const categoryConfig = {
  ...
  praise: { label: '❤️ Praise', color: '#ec4899' },
};

// Severity labels and colors
const severityConfig = {
  blocking: { label: '🚨 Blocking', color: '#ef4444' },
  major: { label: '⚠️ Major', color: '#f59e0b' },
  minor: { label: 'ℹ️ Minor', color: '#6b7280' },
};
...
export default function FeedbackAdminPage() {
  ...
  const exportToCsv = () => {
    const headers = [
      ...
      'Browser', 'Created At', 'Resolved At'
    ];
            ...
            >
              ...
              <div className={styles.feedbackContent}>
                ...
                <div className={styles.feedbackContext}>
                  ...
                  {item.browser_info?.browser && (
                    <span className={styles.contextItem}>
                      🌐 {item.browser_info.browser} / {item.browser_info.os}
                    </span>
                  )}
                </div>

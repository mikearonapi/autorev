 ...
 * Dashboard Icons
 * 
 * Professional SVG icons for the Dashboard page.
 * Consistent 1.5-2px stroke, clean design.
 */

// Garage icon (house/garage)
export const GarageIcon = ({ size = 18 }) => (
...
// Build/Wrench icon
export const BuildIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" 
    strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
// Parts/Shopping icon
export const PartsIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" 
    strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
// Camera/Photo icon
export const PhotoIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" 
    strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const CommunityIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" 
    strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
// Bot/AI icon (legacy - kept for backward compatibility)
...
// Grid icon (4 squares - matches BottomTabBar Community icon)

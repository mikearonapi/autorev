...
// Components
import { ALConversationsDashboard } from './components/ALConversationsDashboard';
...
export default function AdminDashboardPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    const monthYearParams =
      selectedMonth && selectedYear ? `&year=${selectedYear}&month=${selectedMonth}` : '';
  ...
  if (authLoading || !authChecked) {
    return (
      <div className={styles.pageContainer} data-no-main-offset>
        <LoadingSpinner
          variant="branded"
        ...
        <div className={styles.headerContent}>
          <div className={styles.headerTitle}>
            <div className={styles.brandMark}>
              <Image
                src="/images/autorev-logo-transparent.png"
                alt="AutoRev"
                width={60}
                height={60}
                priority
            ...
            <div>
              <h1 className={styles.title}>
                Auto<span className={styles.titleAccent}>Rev</span> Command Center
              </h1>
      ...
      <div className={styles.tabContent}>
        ...
        {activeTab === 'overview' && (
          <>
                ...
                <KPICard
                  ...
                  value={
                    healthData?.health?.status === 'healthy'
                      ? 'Healthy'
                      : healthData?.health?.status === 'warning'
                        ? 'Warning'
                        : healthData?.health?.status === 'critical'
                          ? 'Critical'
                          : 'Checking...'
                  }
                  interpretation={
                    healthData?.errors?.total24h > 0
                  ...
                  <div className={styles.summaryCard}>
                    ...
                    <div className={styles.summaryContent}>
                      ...
                      <div className={`${styles.summaryRow} ${styles.stripeRow}`}>
                        ...
                        <span
                          className={
                            stripeData?.revenue?.mrr > 0 ? styles.positive : styles.neutral
                          }
                        >
                          $
                          {((stripeData?.revenue?.mrr || 0) / 100).toLocaleString(undefined, {
                      ...
                      <div className={styles.summaryRow}>
                        ...
                        <span
                          className={
                            (stripeData?.revenue?.periodTotal || actualRevenue) > 0
                              ? styles.positive
                              : styles.neutral
                          }
                        >
                          $
                          {(
                            (stripeData?.revenue?.periodTotal || 0) / 100 || actualRevenue
                      ...
                      <div className={styles.summaryRow}>
                        ...
                        <span className={productDevTotal > 0 ? styles.negative : styles.neutral}>
                          {productDevTotal > 0
                            ? `-$${productDevTotal.toLocaleString(undefined, { minimumFractionDigits: 2 })}`
                            : '$0.00'}
                        </span>
                      </div>
                      <div className={`${styles.summaryRow} ${styles.summaryTotal}`}>
                        ...
                        <span
                          className={
                            actualRevenue - totalLoss < 0 ? styles.negative : styles.positive
                          }
                        >
            ...
            {/* Unit Economics */}
            <section className={styles.section}>
              <UnitEconomics financials={financials} users={data?.users} loading={loading} />
            </section>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.snapshotGrid}>
                  ...
                  <div className={styles.snapshotContent}>
                    ...
                    <div className={styles.snapshotStat}>
                      <span className={styles.snapshotValue}>
                        {emailStats?.stats?.delivered || emailStats?.stats?.total || 0}
                      </span>
                      <span className={styles.snapshotLabel}>Delivered</span>
                    </div>
                    <div className={styles.snapshotStat}>
                      <span className={styles.snapshotValue}>
                        {emailStats?.stats?.byTemplate?.welcome || 0}
                      </span>
                ...
                <div className={styles.snapshotCard}>
                  ...
                  <div className={styles.snapshotContent}>
                    {(alertsData?.alerts || healthData?.alerts || [])
                      .slice(0, 3)
                      .map((alert, i) => (
                        <div
                          key={i}
                          className={`${styles.snapshotAlert} ${styles[alert.severity]}`}
                        >
        ...
        {/* AL TAB - Conversation Monitoring */}
        {activeTab === 'al' && (
          <section className={styles.section}>
            <ALConversationsDashboard token={session?.access_token} />
          </section>
        )}
          ...
          <section className={styles.section}>
            <div className={styles.tabHeader}>
              ...
              <p className={styles.tabDescription}>
                Search and analyze your user base. View attribution, engagement, tier distribution,
                and individual user details.
              </p>
            </div>
            <UsersDashboard
              token={session?.access_token}
        ...
        {activeTab === 'analytics' && (
          <>
            ...
            <section className={styles.section}>
              <ConsolidatedAnalytics token={session?.access_token} range={timeRange} />
            </section>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.chartsGrid}>
                ...
                <FunnelChart funnel={data?.funnel} title="Conversion Funnel" />
              </div>
            </section>
            ...
            <section className={styles.section}>
              ...
              <RetentionMetrics retention={retentionData} loading={loading} />
            </section>
          </>
        )}
        ...
        {activeTab === 'revenue' && (
          <section className={styles.section}>
            ...
            <StripeDashboard token={session?.access_token} range={timeRange} loading={loading} />
          </section>
        )}
          ...
          <>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.costAnalysisGrid}>
                <CostBreakdown costs={financials?.costs || data?.costs} title="Cost Categories" />
                ...
                <div className={styles.financialSidebarCompact}>
                  ...
                  <UsageEstimate usage={usageData} loading={loading} compact />
                </div>
              </div>
            </section>
            ...
            <section className={styles.section}>
              <CostIntegrations token={session?.access_token} range={timeRange} loading={loading} />
            </section>
          </>
        )}
            ...
            <section className={styles.section}>
              ...
              <div className={styles.kpiGrid}>
                <KPICard
                  ...
                  interpretation={
                    actualRevenue === 0 ? 'Pre-revenue phase' : 'Total collected revenue'
                  }
                  sparklineColor="#22c55e"
                  icon={<TrendingUpIcon size={18} />}
                  loading={loading}
        ...
        {activeTab === 'operations' && (
          <>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.kpiGrid}>
                ...
                <KPICard
                  label="Active Alerts"
                  value={
                    (alertsData?.alerts || healthData?.alerts || []).filter(
                      (a) => a.severity !== 'info'
                    ).length
                  }
                  interpretation={
                  ...
                  sparklineColor={
                    (alertsData?.alerts || healthData?.alerts || []).some(
                ...
                <KPICard
                  label="Content Items"
                  value={
                    (usageData?.content?.vehicles || 0) +
                    (usageData?.content?.events || 0) +
                    (usageData?.content?.parts || 0)
                  }
            ...
            <section className={styles.section}>
              ...
              <SystemHealthPanel health={healthData} loading={loading} />
            </section>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.infrastructureGrid}>
                <VercelStatus token={session?.access_token} loading={loading} />

                <WebVitalsPanel token={session?.access_token} loading={loading} />
              </div>
            </section>
            ...
            <section className={styles.section}>
              ...
              <ALUserUsage token={session?.access_token} range={timeRange} loading={loading} />
            </section>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.operationsPrimaryGrid}>
                <ContentInventory content={usageData?.content || data?.content} loading={loading} />

                <QuickActions token={session?.access_token} onRefresh={fetchData} />
              </div>
            </section>
            ...
            <section className={styles.section}>
              <div className={styles.operationsSecondaryGrid}>
                ...
                <SystemHealth system={data?.system} title="Infrastructure Status" />
              </div>
            </section>

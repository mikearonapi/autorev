...
async function getCarCount(): Promise<number> {
  try {
    ...
    const supabase = supabaseModule.supabase as SupabaseClient | null;
    ...
    if (error) {
      console.error('[Twitter Image] Error fetching car count:', error);
      return 188;
    }

    return count || 188;
  } catch (err) {
    console.error('[Twitter Image] Error in getCarCount:', err);
    return 188;
  }
}
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Find What <span style={{ color: BRAND.gold, marginLeft: '8px' }}>Drives You</span>
        </h1>
        ...
        >
          {[
            ...
            <div
              ...
              style={{
                padding: '10px 18px',
                background: feature.highlight ? `rgba(212,175,55,0.25)` : `rgba(255,255,255,0.08)`,
                borderRadius: '50px',

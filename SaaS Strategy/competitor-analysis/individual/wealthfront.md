# Wealthfront - Competitive Analysis

> **Category**: Finance & Investment | **Subcategory**: robo-advisor  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | 0.25% annual fee |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Projection visualization |
| **Study Focus** | Path visualization tool, Tax-Loss Harvesting messaging, Concrete value communication |
...
1. **Path visualization tool**: [To be analyzed]
2. **Tax-Loss Harvesting messaging**: [To be analyzed]
3. **Concrete value communication**: [To be analyzed]
...
- **Pattern**: Projection visualization
...
- **Company Website**: https://www.wealthfront.com/
- **Pricing Page**: https://www.wealthfront.com/pricing
- **Features Page**: https://www.wealthfront.com/investing
- **About Page**: https://www.wealthfront.com/origin

# MasterClass - Competitive Analysis

> **Category**: Learning & Skill-Building | **Subcategory**: professional  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Subscription ($120-240/yr) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Production value perception |
| **Study Focus** | Expert authority premium, Cinematic production quality, Celebrity instructors |
...
1. **Expert authority premium**: [To be analyzed]
2. **Cinematic production quality**: [To be analyzed]
3. **Celebrity instructors**: [To be analyzed]
...
- **Pattern**: Production value perception
...
- **Company Website**: https://www.masterclass.com/
- **Pricing Page**: https://www.masterclass.com/gift
- **Features Page**: https://www.masterclass.com/browse
- **About Page**: https://www.masterclass.com/about-us

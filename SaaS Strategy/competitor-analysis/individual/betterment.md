# Betterment - Competitive Analysis
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | 0.25% fee (Premium 0.65% with CFP) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Goal-centric UX |
| **Study Focus** | Goal-based organization, Hybrid human + AI service |
...
1. **Goal-based organization**: [To be analyzed]
2. **Hybrid human + AI service**: [To be analyzed]
...
- **Company Website**: https://www.betterment.com/
- **Pricing Page**: https://www.betterment.com/pricing
- **Features Page**: https://www.betterment.com/investing
- **About Page**: https://www.betterment.com/about

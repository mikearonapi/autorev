# Coursera - Competitive Analysis

> **Category**: Learning & Skill-Building | **Subcategory**: academic  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Freemium (Plus $399/yr, degrees $9K-45K) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Career value certificates |
| **Study Focus** | Credentialing drives conversion, Freemium with clear upgrade, AI Coach |
...
1. **Credentialing drives conversion**: [To be analyzed]
2. **Freemium with clear upgrade**: [To be analyzed]
3. **AI Coach**: [To be analyzed]
...
- **Pattern**: Career value certificates
...
- **Company Website**: https://www.coursera.org/
- **Pricing Page**: https://www.coursera.org/courseraplus
- **Features Page**: https://www.coursera.org/courses
- **About Page**: https://about.coursera.org/

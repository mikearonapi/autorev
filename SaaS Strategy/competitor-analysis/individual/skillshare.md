# Skillshare - Competitive Analysis

> **Category**: Learning & Skill-Building | **Subcategory**: creative  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Subscription (~$168/yr) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Community teaching |
| **Study Focus** | Project-based engagement, Creator economy model, Teacher payments |
...
1. **Project-based engagement**: [To be analyzed]
2. **Creator economy model**: [To be analyzed]
3. **Teacher payments**: [To be analyzed]
...
- **Company Website**: https://www.skillshare.com/
- **Pricing Page**: https://www.skillshare.com/membership
- **Features Page**: https://www.skillshare.com/browse
- **About Page**: https://www.skillshare.com/about

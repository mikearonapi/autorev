# Peloton - Competitive Analysis

> **Category**: Fitness & Health | **Subcategory**: connected  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Hardware + Subscription ($49.99/mo All-Access) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Celebrity instructor model |
| **Study Focus** | Instructor-as-brand, Live + on-demand hybrid, Leaderboards |
...
1. **Instructor-as-brand**: [To be analyzed]
2. **Live + on-demand hybrid**: [To be analyzed]
3. **Leaderboards**: [To be analyzed]
...
- **Pattern**: Celebrity instructor model
...
- **Company Website**: https://www.onepeloton.com/
- **Pricing Page**: https://www.onepeloton.com/membership
- **Features Page**: https://www.onepeloton.com/app
- **About Page**: https://www.onepeloton.com/company

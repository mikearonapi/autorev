...
> **Category**: Learning & Skill-Building | **Subcategory**: language  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Freemium (Super $12.99/mo, Max higher) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Gamification mastery |
| **Study Focus** | Streak psychology, Tiered AI monetization, 103M+ MAU |
...
### Desktop Homepage
![Homepage Desktop](../competitor-screenshots/learning/duolingo/desktop/homepage.png)
...
1. **Streak psychology**: [To be analyzed]
2. **Tiered AI monetization**: [To be analyzed]
3. **103M+ MAU**: [To be analyzed]
...
- **Company Website**: https://www.duolingo.com/
- **Pricing Page**: https://www.duolingo.com/super
- **Features Page**: https://www.duolingo.com/efficacy
- **About Page**: https://www.duolingo.com/approach

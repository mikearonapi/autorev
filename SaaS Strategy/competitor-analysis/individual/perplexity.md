...
> **Category**: AI-Native Apps | **Subcategory**: search  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Freemium (Pro $20/mo) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | AI feature tiering excellence |
| **Study Focus** | 5 vs 300+ searches tiering, Source citations build trust, Deep Research |
...
### Desktop Homepage
![Homepage Desktop](../competitor-screenshots/ai-native/perplexity/desktop/homepage.png)
...
1. **5 vs 300+ searches tiering**: [To be analyzed]
2. **Source citations build trust**: [To be analyzed]
3. **Deep Research**: [To be analyzed]
...
- **Pattern**: AI feature tiering excellence
...
- **Features Page**: https://www.perplexity.ai/discover
- **About Page**: https://www.perplexity.ai/about

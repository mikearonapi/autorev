# MyFitnessPal - Competitive Analysis

> **Category**: Fitness & Health | **Subcategory**: nutrition  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Freemium (Premium $19.99/mo or $79.99/yr) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Comprehensive data moat |
| **Study Focus** | Database-as-moat, Barcode quick entry, 14M+ food items |
...
1. **Database-as-moat**: [To be analyzed]
2. **Barcode quick entry**: [To be analyzed]
3. **14M+ food items**: [To be analyzed]
...
- **Pattern**: Comprehensive data moat
...
- **Company Website**: https://www.myfitnesspal.com/
- **Pricing Page**: https://www.myfitnesspal.com/premium
- **Features Page**: https://www.myfitnesspal.com/app
- **About Page**: https://www.myfitnesspal.com/about-us

# Things 3 - Competitive Analysis

> **Category**: Productivity & Focus | **Subcategory**: tasks  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | One-time (~$80 total across devices) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Extreme design polish |
| **Study Focus** | Design excellence as moat, Apple Design Awards, Today/Evening split |
...
1. **Design excellence as moat**: [To be analyzed]
2. **Apple Design Awards**: [To be analyzed]
3. **Today/Evening split**: [To be analyzed]
...
- **Company Website**: https://culturedcode.com/things/
- **Pricing Page**: N/A
- **Features Page**: https://culturedcode.com/things/whats-new/
- **About Page**: https://culturedcode.com/things/support/

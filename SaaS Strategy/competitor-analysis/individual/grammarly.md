# Grammarly - Competitive Analysis

> **Category**: AI-Native Apps | **Subcategory**: writing  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Freemium (Pro $12/mo) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Everywhere integration |
| **Study Focus** | Ubiquitous AI presence, 100 vs 2,000 prompts tiering, Explanations build trust |
...
1. **Ubiquitous AI presence**: [To be analyzed]
2. **100 vs 2,000 prompts tiering**: [To be analyzed]
3. **Explanations build trust**: [To be analyzed]
...
- **Pattern**: Everywhere integration
...
- **Features Page**: https://www.grammarly.com/features
- **About Page**: https://www.grammarly.com/about

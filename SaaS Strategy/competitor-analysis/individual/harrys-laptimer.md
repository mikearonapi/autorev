# Harry's LapTimer - Competitive Analysis

> **Category**: Automotive & Enthusiast | **Subcategory**: racing  
> **URL**: https://www.gps-laptimer.de/  
> **Analyzed**: 2026-01-21
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Tiered one-time (Rookie free, Petrolhead $29.99, Grand Prix $59.99) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Tiered upgrade paths |
| **Study Focus** | Tiered product architecture, Data overlay video, Shareable content |
...
1. **Tiered product architecture**: [To be analyzed]
2. **Data overlay video**: [To be analyzed]
3. **Shareable content**: [To be analyzed]
...
- **Company Website**: https://www.gps-laptimer.de/
- **Pricing Page**: https://www.gps-laptimer.de/products
- **Features Page**: https://www.gps-laptimer.de/features
- **About Page**: N/A

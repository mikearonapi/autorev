# Obsidian - Competitive Analysis

> **Category**: Productivity & Focus | **Subcategory**: notes  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Free core (Sync $8/mo, Publish $16/mo) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Plugin ecosystem stickiness |
| **Study Focus** | Local-first privacy, 1,000+ plugin ecosystem, Free core + premium services |
...
1. **Local-first privacy**: [To be analyzed]
2. **1,000+ plugin ecosystem**: [To be analyzed]
3. **Free core + premium services**: [To be analyzed]
...
- **Pattern**: Plugin ecosystem stickiness
...
- **Company Website**: https://obsidian.md/
- **Pricing Page**: https://obsidian.md/pricing
- **Features Page**: https://obsidian.md/features
- **About Page**: https://obsidian.md/about

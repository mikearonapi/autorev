...
> **Category**: Productivity & Focus | **Subcategory**: workspace  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Freemium (Plus $10/user/mo, Business $20/user/mo) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Viral templates |
| **Study Focus** | Template ecosystem as growth, Contextual AI embedding, Flexible views |
...
1. **Template ecosystem as growth**: [To be analyzed]
2. **Contextual AI embedding**: [To be analyzed]
3. **Flexible views**: [To be analyzed]
...
- **Features Page**: https://www.notion.com/product
- **About Page**: https://www.notion.com/about

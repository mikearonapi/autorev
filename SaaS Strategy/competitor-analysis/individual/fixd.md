# FIXD - Competitive Analysis

> **Category**: Automotive & Enthusiast | **Subcategory**: diagnostics  
> **URL**: https://www.fixd.com/  
> **Analyzed**: 2026-01-21
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Hardware + Premium subscription ($12.99/mo) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | AI as core differentiator |
| **Study Focus** | AI Mechanic chatbot, Plain-English explanations, Severity ratings |
...
### Desktop Homepage
![Homepage Desktop](../competitor-screenshots/automotive/fixd/desktop/homepage.png)

### Mobile Homepage
![Homepage Mobile](../competitor-screenshots/automotive/fixd/mobile/homepage.png)

### Pricing Page (if available)
![Pricing](../competitor-screenshots/automotive/fixd/desktop/pricing.png)
...
1. **AI Mechanic chatbot**: [To be analyzed]
2. **Plain-English explanations**: [To be analyzed]
3. **Severity ratings**: [To be analyzed]
...
- **Pattern**: AI as core differentiator
...
### CTAs Found
- **Primary**: [Not extracted]
- **Secondary**: [Not extracted]

### Pricing Information
| Tier | Price | Key Features |
|------|-------|--------------|
| N/A | N/A | [Not extracted - visit website] |
...
- **Company Website**: https://www.fixd.com/
- **Pricing Page**: https://www.fixd.com/pages/pricing
- **Features Page**: https://www.fixd.com/pages/features
- **About Page**: https://www.fixd.com/pages/about-us

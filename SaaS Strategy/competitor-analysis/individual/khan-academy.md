# Khan Academy - Competitive Analysis
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Free core + Khanmigo ($4/mo) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | AI guides to answers |
| **Study Focus** | Socratic AI design, Mastery-based progression, Free core + AI premium |
...
1. **Socratic AI design**: [To be analyzed]
2. **Mastery-based progression**: [To be analyzed]
3. **Free core + AI premium**: [To be analyzed]
...
- **Company Website**: https://www.khanacademy.org/
- **Pricing Page**: https://www.khanacademy.org/khan-labs
- **Features Page**: https://www.khanacademy.org/about
- **About Page**: https://www.khanacademy.org/about/the-team

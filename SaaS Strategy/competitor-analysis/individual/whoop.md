# Whoop - Competitive Analysis

> **Category**: Fitness & Health | **Subcategory**: wearable  
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Subscription-only with hardware (Peak $199-239/yr) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Commitment through subscription |
| **Study Focus** | Hardware-as-a-Service, Daily readiness score, Journal behavior correlation |
...
1. **Hardware-as-a-Service**: [To be analyzed]
2. **Daily readiness score**: [To be analyzed]
3. **Journal behavior correlation**: [To be analyzed]
...
- **Pattern**: Commitment through subscription
...
- **Pricing Page**: https://www.whoop.com/membership/
- **Features Page**: https://www.whoop.com/experience/
- **About Page**: https://www.whoop.com/company/

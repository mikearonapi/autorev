# OBDeleven - Competitive Analysis
...
| Attribute | Value |
|-----------|-------|
| **Business Model** | Hardware + Subscription (PRO $49.99/yr, ULTIMATE $99.99/yr) |
| **Target Audience** | [To be analyzed] |
| **Key Differentiator** | Hardware + subscription model |
| **Study Focus** | Hardware + software bundle, One-Click Apps, Manufacturer licensing |
...
### Desktop Homepage
![Homepage Desktop](../competitor-screenshots/automotive/obdeleven/desktop/homepage.png)

### Mobile Homepage
![Homepage Mobile](../competitor-screenshots/automotive/obdeleven/mobile/homepage.png)

### Pricing Page (if available)
![Pricing](../competitor-screenshots/automotive/obdeleven/desktop/pricing.png)
...
1. **Hardware + software bundle**: [To be analyzed]
2. **One-Click Apps**: [To be analyzed]
3. **Manufacturer licensing**: [To be analyzed]
...
- **Company Website**: https://obdeleven.com/
- **Pricing Page**: https://obdeleven.com/en/pricing
- **Features Page**: https://obdeleven.com/en/features
- **About Page**: https://obdeleven.com/en/about-us
